load('t1','chrome','browserAction').
load('t2','t1','onClicked').
...
formal('d_lambda_R_1','1','tab_R_1').
assign('alreadyOpened_R_1','null').
assign('chromeExtURL_R_1','chrome://downloads/').
load('t6','chrome','tabs').
load('t7','t6','getAllInWindow').
actual('1','1','null').
callRet('1','null').
actual('1','2','lambda_R_2').
...
formal('d_lambda_R_2','1','tabs_R_2').
load('t10','tabs_R_2','length').
assign('t9','t11').
assign('i_R_2','0').
assign('t13','i_R_2').
assign('t12','t13').
load('t15','tabs_R_2','i_R_2').
load('t16','t15','url').
assign('t14','t17').
load('t19','chrome','tabs').
load('t20','t19','update').
load('t21','tabs_R_2','i_R_2').
load('t22','t21','id').
store('t23','selected_R_?','true').
actual('2','1','t22').
callRet('2','t22').
actual('2','2','t23').
callRet('2','t23').
assign('t18','t24').
methodRet('d_lambda_R_2','null').
assign('i_R_2','0').
load('t26','chrome','tabs').
load('t27','t26','create').
store('t28','url_R_?','chromeExtURL').
store('t28','selected_R_?','true').
actual('3','1','t28').
callRet('3','t28').
assign('t25','t29').
% basicrules.pl
