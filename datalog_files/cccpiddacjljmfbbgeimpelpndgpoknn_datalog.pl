ptsTo('get_manifest_R_1','d_get_manifest_R_1').
heapPtsTo('d_get_manifest_R_1','prototype','p_get_manifest_R_1').
prototype('p_get_manifest_R_1','h_FP').
methodRet('d_get_manifest_R_1','get_manifest_R_1').
formal('d_get_manifest_R_1','1','callback_R_1').
actual('0','1','lambda_R_3').
...
formal('d_lambda_R_3','1','manifest_R_3').
ptsTo('setDefault_R_4','d_setDefault_R_4').
heapPtsTo('d_setDefault_R_4','prototype','p_setDefault_R_4').
prototype('p_setDefault_R_4','h_FP').
methodRet('d_setDefault_R_4','setDefault_R_4').
formal('d_setDefault_R_4','1','key_R_4').
formal('d_setDefault_R_4','2','value_R_4').
ptsTo('init_R_5','d_init_R_5').
heapPtsTo('d_init_R_5','prototype','p_init_R_5').
prototype('p_init_R_5','h_FP').
methodRet('d_init_R_5','init_R_5').
load('t3','chrome','extension').
load('t4','t3','onConnect').
load('t5','t4','addListener').
actual('1','1','lambda_R_6').
callRet('1','lambda_R_6').
assign('t2','t6').
...
formal('d_lambda_R_6','1','port_R_6').
actual('2','1','window').
callRet('2','window').
assign('t7','t8').
...
formal('d_lambda_R_7','1','window_R_7').
formal('d_lambda_R_7','2','undefined_R_7').
assign('t9','t10').
...
formal('d_lambda_R_39','1','window_R_39').
assign('framerate_R_0','150').
assign('animtime_R_0','400').
assign('stepsize_R_0','120').
assign('pulseAlgorithm_R_0','true').
assign('pulseScale_R_0','8').
assign('pulseNormalize_R_0','1').
assign('acceleration_R_0','true').
assign('accelDelta_R_0','20').
assign('accelMax_R_0','1').
assign('keyboardsupport_R_0','true').
assign('disableKeyboard_R_0','false').
assign('arrowscroll_R_0','50').
assign('exclude_R_0','').
assign('disabled_R_0','false').
assign('frame_R_0','false').
store('direction_R_0','x_R_?','0').
store('direction_R_0','y_R_?','0').
assign('direction_R_0','__objectInit__').
assign('initdone_R_0','false').
assign('fixedback_R_0','true').
load('t23','document','documentElement').
assign('root_R_0','t23').
assign('activeElement_R_0','__undefined__').
store('key_R_0','left_R_?','37').
store('key_R_0','up_R_?','38').
store('key_R_0','right_R_?','39').
store('key_R_0','down_R_?','40').
store('key_R_0','spacebar_R_?','32').
store('key_R_0','pageup_R_?','33').
store('key_R_0','pagedown_R_?','34').
store('key_R_0','end_R_?','35').
store('key_R_0','home_R_?','36').
assign('key_R_0','__objectInit__').
load('t25','chrome','extension').
load('t26','t25','connect').
store('t27','name_R_?','smoothscroll').
actual('10','1','t27').
callRet('10','t27').
load('t29','t28','onMessage').
load('t30','t29','addListener').
actual('11','1','lambda_R_46').
callRet('11','lambda_R_46').
assign('t24','t31').
...
formal('d_lambda_R_46','1','settings_R_46').
ptsTo('initTest_R_47','d_initTest_R_47').
heapPtsTo('d_initTest_R_47','prototype','p_initTest_R_47').
prototype('p_initTest_R_47','h_FP').
methodRet('d_initTest_R_47','initTest_R_47').
ptsTo('init_R_48','d_init_R_48').
heapPtsTo('d_init_R_48','prototype','p_init_R_48').
prototype('p_init_R_48','h_FP').
methodRet('d_init_R_48','init_R_48').
assign('que_R_0','que_R_0').
assign('pending_R_0','false').
ptsTo('t32','n_Date_R_?_0').
prototype('n_Date_R_?_0', 'p_Date_R_?').
assign('lastScroll_R_0','t32').
ptsTo('scrollArray_R_51','d_scrollArray_R_51').
heapPtsTo('d_scrollArray_R_51','prototype','p_scrollArray_R_51').
prototype('p_scrollArray_R_51','h_FP').
methodRet('d_scrollArray_R_51','scrollArray_R_51').
formal('d_scrollArray_R_51','1','elem_R_51').
formal('d_scrollArray_R_51','2','left_R_51').
formal('d_scrollArray_R_51','3','top_R_51').
formal('d_scrollArray_R_51','4','delay_R_51').
ptsTo('wheel_R_53','d_wheel_R_53').
heapPtsTo('d_wheel_R_53','prototype','p_wheel_R_53').
prototype('p_wheel_R_53','h_FP').
methodRet('d_wheel_R_53','wheel_R_53').
formal('d_wheel_R_53','1','event_R_53').
ptsTo('keydown_R_54','d_keydown_R_54').
heapPtsTo('d_keydown_R_54','prototype','p_keydown_R_54').
prototype('p_keydown_R_54','h_FP').
methodRet('d_keydown_R_54','keydown_R_54').
formal('d_keydown_R_54','1','event_R_54').
ptsTo('mousedown_R_55','d_mousedown_R_55').
heapPtsTo('d_mousedown_R_55','prototype','p_mousedown_R_55').
prototype('p_mousedown_R_55','h_FP').
methodRet('d_mousedown_R_55','mousedown_R_55').
formal('d_mousedown_R_55','1','event_R_55').
assign('cache_R_0','__objectInit__').
actual('12','1','lambda_R_56').
callRet('12','lambda_R_56').
actual('12','2','t34').
callRet('12','t34').
assign('t33','t35').
...
ptsTo('setCache_R_59','d_setCache_R_59').
heapPtsTo('d_setCache_R_59','prototype','p_setCache_R_59').
prototype('p_setCache_R_59','h_FP').
methodRet('d_setCache_R_59','setCache_R_59').
formal('d_setCache_R_59','1','elems_R_59').
formal('d_setCache_R_59','2','overflowing_R_59').
ptsTo('overflowingAncestor_R_60','d_overflowingAncestor_R_60').
heapPtsTo('d_overflowingAncestor_R_60','prototype','p_overflowingAncestor_R_60').
prototype('p_overflowingAncestor_R_60','h_FP').
methodRet('d_overflowingAncestor_R_60','overflowingAncestor_R_60').
formal('d_overflowingAncestor_R_60','1','el_R_60').
ptsTo('addEvent_R_61','d_addEvent_R_61').
heapPtsTo('d_addEvent_R_61','prototype','p_addEvent_R_61').
prototype('p_addEvent_R_61','h_FP').
methodRet('d_addEvent_R_61','addEvent_R_61').
formal('d_addEvent_R_61','1','type_R_61').
formal('d_addEvent_R_61','2','fn_R_61').
formal('d_addEvent_R_61','3','bubble_R_61').
ptsTo('removeEvent_R_62','d_removeEvent_R_62').
heapPtsTo('d_removeEvent_R_62','prototype','p_removeEvent_R_62').
prototype('p_removeEvent_R_62','h_FP').
methodRet('d_removeEvent_R_62','removeEvent_R_62').
formal('d_removeEvent_R_62','1','type_R_62').
formal('d_removeEvent_R_62','2','fn_R_62').
formal('d_removeEvent_R_62','3','bubble_R_62').
ptsTo('isNodeName_R_63','d_isNodeName_R_63').
heapPtsTo('d_isNodeName_R_63','prototype','p_isNodeName_R_63').
prototype('p_isNodeName_R_63','h_FP').
methodRet('d_isNodeName_R_63','isNodeName_R_63').
formal('d_isNodeName_R_63','1','el_R_63').
formal('d_isNodeName_R_63','2','tag_R_63').
ptsTo('directionCheck_R_64','d_directionCheck_R_64').
heapPtsTo('d_directionCheck_R_64','prototype','p_directionCheck_R_64').
prototype('p_directionCheck_R_64','h_FP').
methodRet('d_directionCheck_R_64','directionCheck_R_64').
formal('d_directionCheck_R_64','1','x_R_64').
formal('d_directionCheck_R_64','2','y_R_64').
assign('requestFrame_R_0','t37').
...
ptsTo('pulse__R_67','d_pulse__R_67').
heapPtsTo('d_pulse__R_67','prototype','p_pulse__R_67').
prototype('p_pulse__R_67','h_FP').
methodRet('d_pulse__R_67','pulse__R_67').
formal('d_pulse__R_67','1','x_R_67').
ptsTo('pulse_R_68','d_pulse_R_68').
heapPtsTo('d_pulse_R_68','prototype','p_pulse_R_68').
prototype('p_pulse_R_68','h_FP').
methodRet('d_pulse_R_68','pulse_R_68').
formal('d_pulse_R_68','1','x_R_68').
actual('15','1','mousedown').
callRet('15','mousedown').
actual('15','2','mousedown_R_?').
callRet('15','mousedown_R_?').
assign('t38','t39').
actual('16','1','mousewheel').
callRet('16','mousewheel').
actual('16','2','wheel_R_?').
callRet('16','wheel_R_?').
assign('t40','t41').
actual('17','1','load').
callRet('17','load').
...
callRet('17','init_R_?').
assign('t42','t43').
ptsTo('t44','n_XMLHttpRequest_R_?_1').
prototype('n_XMLHttpRequest_R_?_1', 'p_XMLHttpRequest_R_?').
assign('xhr_R_1','t44').
load('t45','xhr_R_1','onload').
store('xhr_R_1','onload','lambda_R_2').
...
load('t47','xhr_R_1','open_R_?').
actual('18','1','GET').
callRet('18','GET').
actual('18','2','../manifest.json').
callRet('18','../manifest.json').
actual('18','3','true').
callRet('18','true').
assign('t46','t48').
load('t50','xhr_R_1','send_R_?').
actual('19','1','null').
callRet('19','null').
assign('t49','t51').
load('t53','JSON_R_?','parse_R_?').
load('t54','xhr_R_1','responseText').
actual('20','1','t54').
callRet('20','t54').
actual('21','1','t55').
callRet('21','t55').
assign('t52','t56').
load('t57','manifest_R_3','version').
assign('version_R_?','t57').
assign('t58','t59').
load('t61','localStorage_R_?','key_R_4').
assign('t60','t62').
load('t63','localStorage_R_?','key_R_4').
store('localStorage_R_?','key_R_4','value_R_4').
actual('23','1','version').
callRet('23','version').
actual('23','2','version_R_?').
callRet('23','version_R_?').
assign('t64','t65').
actual('24','1','framerate').
callRet('24','framerate').
actual('24','2','150').
callRet('24','150').
assign('t66','t67').
actual('25','1','animtime').
callRet('25','animtime').
actual('25','2','400').
callRet('25','400').
assign('t68','t69').
actual('26','1','scrollsz').
callRet('26','scrollsz').
actual('26','2','120').
callRet('26','120').
assign('t70','t71').
actual('27','1','middlemouse').
callRet('27','middlemouse').
actual('27','2','true').
callRet('27','true').
assign('t72','t73').
actual('28','1','accelMax').
callRet('28','accelMax').
actual('28','2','1').
callRet('28','1').
assign('t74','t75').
actual('29','1','accelDelta').
callRet('29','accelDelta').
actual('29','2','20').
callRet('29','20').
assign('t76','t77').
actual('30','1','pulseAlgorithm').
callRet('30','pulseAlgorithm').
actual('30','2','true').
callRet('30','true').
assign('t78','t79').
actual('31','1','pulseScale').
callRet('31','pulseScale').
actual('31','2','8').
callRet('31','8').
assign('t80','t81').
actual('32','1','pulseNormalize').
callRet('32','pulseNormalize').
actual('32','2','1').
callRet('32','1').
assign('t82','t83').
actual('33','1','keyboardsupport').
callRet('33','keyboardsupport').
actual('33','2','true').
callRet('33','true').
assign('t84','t85').
actual('34','1','arrscroll').
callRet('34','arrscroll').
actual('34','2','50').
callRet('34','50').
assign('t86','t87').
actual('35','1','fixedback').
callRet('35','fixedback').
actual('35','2','true').
callRet('35','true').
assign('t88','t89').
actual('36','1','exclude').
callRet('36','exclude').
actual('36','2','example.com, another.example.com').
callRet('36','example.com, another.example.com').
assign('t90','t91').
assign('store_R_5','localStorage_R_?').
load('t93','store_R_5','version').
assign('t94','t93').
assign('t92','t94').
load('t96','store_R_5','version').
assign('t95','t97').
load('t98','store_R_5','version').
store('store_R_5','version','version_R_?').
load('t100','store_R_5','framerate').
assign('t99','t101').
load('t102','store_R_5','framerate').
store('store_R_5','framerate','150').
load('t103','store_R_5','exclude').
load('t104','store_R_5','exclude').
load('t105','t104','replace_R_?').
actual('37','1','{"regexp": " ", "modifiers": "g"}').
callRet('37','{"regexp": " ", "modifiers": "g"}').
actual('37','2','').
callRet('37','None').
store('store_R_5','exclude','t106').
assign('list_R_5','list_R_5').
load('t107','store_R_5','exclude').
load('t108','t107','split_R_?').
actual('38','1','{"regexp": "[,\\n] ?", "modifiers": ""}').
callRet('38','{"regexp": "[,\\n] ?", "modifiers": ""}').
assign('domains_R_5','t109').
load('t111','domains_R_5','length').
assign('t110','t112').
assign('i_R_5','0').
assign('t114','i_R_5').
assign('t113','t114').
load('t116','domains_R_5','i_R_5').
assign('t115','t117').
load('t119','domains_R_5','i_R_5').
load('t120','domains_R_5','i_R_5').
assign('t118','t122').
load('t124','list_R_5','push_R_?').
load('t125','domains_R_5','i_R_5').
actual('39','1','t125').
callRet('39','t125').
assign('t123','t126').
load('t127','store_R_5','fixedback').
store('store_R_5','fixedback','false').
assign('i_R_5','0').
load('t128','store_R_5','exclude').
load('t129','list_R_5','join_R_?').
actual('40','1',', ').
callRet('40',', ').
store('store_R_5','exclude','t130').
load('t132','port_R_6','name').
assign('t131','t133').
load('t135','port_R_6','postMessage_R_?').
actual('41','1','localStorage_R_?').
callRet('41','localStorage_R_?').
assign('t134','t136').
store('options_R_7','0','animtime').
store('options_R_7','1','scrollsz').
store('options_R_7','2','arrscroll').
store('options_R_7','3','middlemouse').
store('options_R_7','4','accelMax').
store('options_R_7','5','accelDelta').
store('options_R_7','6','pulseAlgorithm').
store('options_R_7','7','pulseScale').
store('options_R_7','8','keyboardsupport').
store('options_R_7','9','exclude').
store('options_R_7','10','fixedback').
assign('options_R_7','options_R_7').
ptsTo('byId_R_8','d_byId_R_8').
heapPtsTo('d_byId_R_8','prototype','p_byId_R_8').
prototype('p_byId_R_8','h_FP').
methodRet('d_byId_R_8','byId_R_8').
formal('d_byId_R_8','1','id_R_8').
ptsTo('byClass_R_9','d_byClass_R_9').
heapPtsTo('d_byClass_R_9','prototype','p_byClass_R_9').
prototype('p_byClass_R_9','h_FP').
methodRet('d_byClass_R_9','byClass_R_9').
formal('d_byClass_R_9','1','cname_R_9').
ptsTo('byTag_R_10','d_byTag_R_10').
heapPtsTo('d_byTag_R_10','prototype','p_byTag_R_10').
prototype('p_byTag_R_10','h_FP').
methodRet('d_byTag_R_10','byTag_R_10').
formal('d_byTag_R_10','1','tag_R_10').
formal('d_byTag_R_10','2','base_R_10').
ptsTo('isNodeName_R_11','d_isNodeName_R_11').
heapPtsTo('d_isNodeName_R_11','prototype','p_isNodeName_R_11').
prototype('p_isNodeName_R_11','h_FP').
methodRet('d_isNodeName_R_11','isNodeName_R_11').
formal('d_isNodeName_R_11','1','el_R_11').
formal('d_isNodeName_R_11','2','tag_R_11').
ptsTo('show_R_12','d_show_R_12').
heapPtsTo('d_show_R_12','prototype','p_show_R_12').
prototype('p_show_R_12','h_FP').
methodRet('d_show_R_12','show_R_12').
formal('d_show_R_12','1','elem_R_12').
formal('d_show_R_12','2','newop_R_12').
ptsTo('hide_R_14','d_hide_R_14').
heapPtsTo('d_hide_R_14','prototype','p_hide_R_14').
prototype('p_hide_R_14','h_FP').
methodRet('d_hide_R_14','hide_R_14').
formal('d_hide_R_14','1','elem_R_14').
formal('d_hide_R_14','2','newop_R_14').
ptsTo('init_R_16','d_init_R_16').
heapPtsTo('d_init_R_16','prototype','p_init_R_16').
prototype('p_init_R_16','h_FP').
methodRet('d_init_R_16','init_R_16').
ptsTo('save_R_19','d_save_R_19').
heapPtsTo('d_save_R_19','prototype','p_save_R_19').
prototype('p_save_R_19','h_FP').
methodRet('d_save_R_19','save_R_19').
ptsTo('get_manifest_R_21','d_get_manifest_R_21').
heapPtsTo('d_get_manifest_R_21','prototype','p_get_manifest_R_21').
prototype('p_get_manifest_R_21','h_FP').
methodRet('d_get_manifest_R_21','get_manifest_R_21').
formal('d_get_manifest_R_21','1','callback_R_21').
actual('42','1','lambda_R_23').
callRet('42','lambda_R_23').
assign('t137','t138').
...
formal('d_lambda_R_23','1','manifest_R_23').
ptsTo('reload_R_24','d_reload_R_24').
heapPtsTo('d_reload_R_24','prototype','p_reload_R_24').
prototype('p_reload_R_24','h_FP').
methodRet('d_reload_R_24','reload_R_24').
store('t139','animtime','160').
store('t139','scrollsz','120').
store('t139','pulseAlgorithm','true').
store('t139','pulseScale','4').
store('profiles_R_7','_custom','t139').
store('t140','animtime','400').
store('t140','scrollsz','120').
store('t140','pulseAlgorithm','true').
store('t140','pulseScale','8').
store('profiles_R_7','_default','t140').
store('t141','animtime','400').
store('t141','scrollsz','120').
store('t141','pulseAlgorithm','true').
store('t141','pulseScale','4').
store('profiles_R_7','_iphone','t141').
store('t142','animtime','120').
store('t142','scrollsz','120').
store('t142','pulseAlgorithm','false').
store('profiles_R_7','_opera','t142').
store('t143','animtime','60').
store('t143','scrollsz','120').
store('t143','pulseAlgorithm','false').
store('profiles_R_7','_ie9','t143').
assign('profiles_R_7','__objectInit__').
ptsTo('set_profile_R_25','d_set_profile_R_25').
heapPtsTo('d_set_profile_R_25','prototype','p_set_profile_R_25').
prototype('p_set_profile_R_25','h_FP').
methodRet('d_set_profile_R_25','set_profile_R_25').
formal('d_set_profile_R_25','1','profile_R_25').
ptsTo('generate_test_R_26','d_generate_test_R_26').
heapPtsTo('d_generate_test_R_26','prototype','p_generate_test_R_26').
prototype('p_generate_test_R_26','h_FP').
methodRet('d_generate_test_R_26','generate_test_R_26').
load('t145','window','addEventListener_R_?').
actual('43','1','DOMContentLoaded').
callRet('43','DOMContentLoaded').
actual('43','2','init_R_?').
callRet('43','init_R_?').
actual('43','3','false').
callRet('43','false').
assign('t144','t146').
load('t148','window','addEventListener').
actual('44','1','DOMContentLoaded').
callRet('44','DOMContentLoaded').
actual('44','2','generate_test_R_?').
callRet('44','generate_test_R_?').
actual('44','3','false').
callRet('44','false').
assign('t147','t149').
load('t150','window','reload').
store('window','reload','reload_R_?').
load('t151','window','save').
store('window','save','save_R_?').
load('t152','window','set_profile').
store('window','set_profile','set_profile_R_?').
load('t153','document','getElementById_R_?').
actual('45','1','id_R_8').
callRet('45','id_R_8').
methodRet('d_byId_R_8','t154').
load('t155','document','getElementsByClassName_R_?').
actual('46','1','cname_R_9').
callRet('46','cname_R_9').
methodRet('d_byClass_R_9','t156').
load('t158','t157','getElementsByTagName_R_?').
actual('47','1','t159').
callRet('47','t159').
methodRet('d_byTag_R_10','t160').
load('t161','el_R_11','nodeName').
load('t162','t161','toLowerCase_R_?').
load('t164','tag_R_11','toLowerCase').
methodRet('d_isNodeName_R_11','t166').
load('t167','elem_R_12','style').
load('t168','t167','display').
store('t167','display','block').
load('t169','elem_R_12','style').
load('t170','t169','webkitTransition').
store('t169','webkitTransition','opacity 0.2s ease-in-out').
actual('50','1','lambda_R_13').
callRet('50','lambda_R_13').
actual('50','2','0').
callRet('50','0').
assign('t171','t172').
...
load('t173','elem_R_12','style').
load('t174','t173','opacity').
store('t173','opacity','t175').
load('t176','elem_R_14','style').
load('t177','t176','webkitTransition').
store('t176','webkitTransition','opacity 1s ease-in-out').
load('t178','elem_R_14','style').
load('t179','t178','opacity').
store('t178','opacity','t180').
actual('51','1','lambda_R_15').
callRet('51','lambda_R_15').
actual('51','2','1000').
callRet('51','1000').
assign('t181','t182').
...
load('t183','elem_R_14','style').
load('t184','t183','display').
store('t183','display','none').
load('t186','localStorage_R_?','saved').
assign('t185','t187').
actual('52','1','dialog').
callRet('52','dialog').
load('t189','t188','0').
assign('dialog_R_16','t189').
actual('53','1','dialog_R_16').
callRet('53','dialog_R_16').
actual('53','2','0.9').
callRet('53','0.9').
assign('t190','t191').
actual('54','1','lambda_R_17').
callRet('54','lambda_R_17').
actual('54','2','3000').
callRet('54','3000').
assign('t192','t193').
...
load('t194','localStorage_R_?','saved').
store('localStorage_R_?','saved','false').
load('t196','options_R_7','forEach_R_?').
actual('55','1','lambda_R_18').
callRet('55','lambda_R_18').
assign('t195','t197').
...
formal('d_lambda_R_18','1','key_R_18').
formal('d_lambda_R_18','2','i_R_18').
actual('56','1','dialog_R_16').
callRet('56','dialog_R_16').
assign('t198','t199').
load('t201','{"regexp": "keyboardsupport|middlemouse|pulseAlgorithm|fixedback", "modifiers": ""}','test_R_?').
actual('57','1','key_R_18').
callRet('57','key_R_18').
assign('t200','t202').
load('t204','localStorage_R_?','key_R_18').
assign('t203','t204').
load('t205','byId_R_8','key_R_18').
load('t206','t205','value').
load('t207','localStorage_R_?','key_R_18').
store('t205','value','t207').
load('t208','byId_R_?','key_R_18').
load('t209','t208','checked').
load('t210','localStorage_R_?','key_R_18').
store('t208','checked','t211').
assign('i_R_19','__undefined__').
assign('key_R_0','__undefined__').
assign('opt_R_?','__undefined__').
assign('elem_R_?','__undefined__').
assign('error_R_?','__undefined__').
load('t213','options_R_7','forEach_R_?').
actual('58','1','lambda_R_20').
callRet('58','lambda_R_20').
assign('t212','t214').
...
formal('d_lambda_R_20','1','key_R_20').
formal('d_lambda_R_20','2','i_R_20').
assign('t216','error_R_?').
assign('t215','t216').
actual('59','1','error_R_?').
callRet('59','error_R_?').
assign('t217','t218').
load('t219','localStorage_R_?','saved').
store('localStorage_R_?','saved','true').
assign('t220','t221').
load('t223','{"regexp": "keyboardsupport|middlemouse|pulseAlgorithm|fixedback", "modifiers": ""}','test_R_?').
actual('61','1','key_R_20').
callRet('61','key_R_20').
assign('t225','t224').
assign('t222','t225').
load('t226','localStorage_R_?','key_R_20').
actual('62','1','key_R_20').
callRet('62','key_R_20').
load('t228','t227','checked').
store('localStorage_R_?','key_R_20','t228').
actual('63','1','key_R_20').
callRet('63','key_R_20').
assign('elem_R_?','t229').
load('t230','elem_R_?','value').
assign('opt_R_?','t230').
actual('64','1','elem_R_?').
callRet('64','elem_R_?').
actual('64','2','input').
...
callRet('66','opt_R_?').
assign('t234','t235').
assign('error_R_?','Numeric Values Only!').
methodRet('d_lambda_R_20','null').
load('t236','localStorage_R_?','key_R_20').
store('localStorage_R_?','key_R_20','opt_R_?').
ptsTo('t237','n_XMLHttpRequest_R_?_2').
prototype('n_XMLHttpRequest_R_?_2', 'p_XMLHttpRequest_R_?').
assign('xhr_R_21','t237').
load('t238','xhr_R_21','onload').
store('xhr_R_21','onload','lambda_R_22').
...
load('t240','xhr_R_21','open_R_?').
actual('67','1','GET').
callRet('67','GET').
actual('67','2','../manifest.json').
callRet('67','../manifest.json').
actual('67','3','true').
callRet('67','true').
assign('t239','t241').
load('t243','xhr_R_21','send_R_?').
actual('68','1','null').
callRet('68','null').
assign('t242','t244').
load('t246','JSON_R_?','parse_R_?').
load('t247','xhr_R_21','responseText').
actual('69','1','t247').
callRet('69','t247').
actual('70','1','t248').
callRet('70','t248').
assign('t245','t249').
load('t250','manifest_R_23','version').
assign('version_R_?','t250').
load('t251','byId_R_8','version').
load('t252','t251','innerHTML').
store('t251','innerHTML','version_R_?').
load('t254','window','location').
load('t255','t254','reload_R_?').
assign('t253','t256').
assign('t257','t258').
assign('t259','t260').
methodRet('d_set_profile_R_25','null').
load('t262','profiles_R_7','t261').
assign('profile_R_25','t262').
load('t264','{"regexp": "keyboardsupport|middlemouse|pulseAlgorithm|fixedback", "modifiers": ""}','test_R_?').
actual('73','1','key_R_25').
callRet('73','key_R_25').
assign('t263','t265').
load('t267','localStorage_R_?','key_R_25').
assign('t266','t267').
load('t268','byId_R_8','key_R_25').
load('t269','t268','value').
load('t270','profile_R_25','key_R_25').
store('t268','value','t270').
load('t271','byId_R_?','key_R_25').
load('t272','t271','checked').
load('t273','profile_R_25','key_R_25').
store('t271','checked','t274').
assign('key_R_25','__undefined__').
actual('74','1','test').
callRet('74','test').
assign('test_R_26','t275').
actual('75','1','div').
callRet('75','div').
actual('75','2','test_R_26').
callRet('75','test_R_26').
load('t277','t276','0').
assign('el_R_26','t277').
assign('t279','i_R_26').
assign('t278','t279').
assign('i_R_26','5').
load('t281','test_R_26','appendChild_R_?').
load('t282','el_R_26','cloneNode_R_?').
actual('76','1','true').
callRet('76','true').
actual('77','1','t283').
callRet('77','t283').
assign('t280','t284').
assign('i_R_26','5').
load('t285','document','getElementById_R_?').
actual('78','1','_added_by_transform_0').
callRet('78','_added_by_transform_0').
assign('temp_R_27','t286').
load('t288','temp_R_27','addEventListener_R_?').
actual('79','1','click').
callRet('79','click').
actual('79','2','lambda_R_28').
callRet('79','lambda_R_28').
assign('t287','t289').
...
formal('d_lambda_R_28','1','event_R_28').
actual('80','1','custom').
callRet('80','custom').
assign('t290','t291').
load('t292','document','getElementById_R_?').
actual('81','1','_added_by_transform_1').
callRet('81','_added_by_transform_1').
assign('temp_R_29','t293').
load('t295','temp_R_29','addEventListener_R_?').
actual('82','1','click').
callRet('82','click').
actual('82','2','lambda_R_30').
callRet('82','lambda_R_30').
assign('t294','t296').
...
formal('d_lambda_R_30','1','event_R_30').
actual('83','1','default').
callRet('83','default').
assign('t297','t298').
load('t299','document','getElementById_R_?').
actual('84','1','_added_by_transform_2').
callRet('84','_added_by_transform_2').
assign('temp_R_31','t300').
load('t302','temp_R_31','addEventListener_R_?').
actual('85','1','click').
callRet('85','click').
actual('85','2','lambda_R_32').
...
formal('d_lambda_R_32','1','event_R_32').
actual('86','1','iphone').
callRet('86','iphone').
assign('t304','t305').
load('t306','document','getElementById_R_?').
actual('87','1','_added_by_transform_3').
callRet('87','_added_by_transform_3').
assign('temp_R_33','t307').
load('t309','temp_R_33','addEventListener_R_?').
actual('88','1','click').
callRet('88','click').
actual('88','2','lambda_R_34').
callRet('88','lambda_R_34').
assign('t308','t310').
...
callRet('89','opera').
assign('t311','t312').
load('t313','document','getElementById_R_?').
actual('90','1','_added_by_transform_4').
callRet('90','_added_by_transform_4').
assign('temp_R_35','t314').
load('t316','temp_R_35','addEventListener_R_?').
actual('91','1','click').
callRet('91','click').
actual('91','2','lambda_R_36').
callRet('91','lambda_R_36').
assign('t315','t317').
...
formal('d_lambda_R_36','1','event_R_36').
actual('92','1','ie9').
callRet('92','ie9').
assign('t318','t319').
load('t320','document','getElementById_R_?').
actual('93','1','save').
callRet('93','save').
assign('temp_R_37','t321').
load('t323','temp_R_37','addEventListener_R_?').
actual('94','1','click').
callRet('94','click').
actual('94','2','lambda_R_38').
callRet('94','lambda_R_38').
assign('t322','t324').
...
assign('t325','t326').
load('t327','document','createElement_R_?').
actual('96','1','div').
callRet('96','div').
assign('img_R_39','t328').
assign('scrolling_R_39','false').
assign('enabled_R_39','false').
assign('framerate_R_39','200').
load('t329','navigator_R_?','platform').
load('t330','t329','indexOf_R_?').
actual('97','1','Linux').
callRet('97','Linux').
assign('t332','1').
assign('isLinux_R_39','t333').
load('t335','chrome','extension').
load('t336','t335','connect').
store('t337','name_R_?','smoothscroll').
actual('98','1','t337').
callRet('98','t337').
load('t339','t338','onMessage').
load('t340','t339','addListener').
actual('99','1','lambda_R_40').
callRet('99','lambda_R_40').
assign('t334','t341').
...
formal('d_lambda_R_40','1','settings_R_40').
ptsTo('init_R_41','d_init_R_41').
heapPtsTo('d_init_R_41','prototype','p_init_R_41').
prototype('p_init_R_41','h_FP').
methodRet('d_init_R_41','init_R_41').
ptsTo('mousedown_R_42','d_mousedown_R_42').
heapPtsTo('d_mousedown_R_42','prototype','p_mousedown_R_42').
prototype('p_mousedown_R_42','h_FP').
methodRet('d_mousedown_R_42','mousedown_R_42').
formal('d_mousedown_R_42','1','e_R_42').
actual('100','1','mousedown').
callRet('100','mousedown').
actual('100','2','mousedown_R_?').
callRet('100','mousedown_R_?').
assign('t342','t343').
actual('101','1','DOMContentLoaded').
callRet('101','DOMContentLoaded').
actual('101','2','init_R_?').
callRet('101','init_R_?').
assign('t344','t345').
load('t346','settings_R_40','middlemouse').
assign('t348','disabled_R_0').
assign('enabled_R_39','t349').
load('t350','settings_R_40','framerate').
assign('framerate_R_39','t351').
load('t352','chrome','extension').
load('t353','t352','getURL').
actual('102','1','../img/cursor.png').
callRet('102','../img/cursor.png').
assign('url_R_41','t354').
load('t355','img_R_39','style').
assign('style_R_41','t355').
load('t356','style_R_41','background').
store('style_R_41','background','t358').
load('t359','style_R_41','position').
store('style_R_41','position','fixed').
load('t360','style_R_41','zIndex').
store('style_R_41','zIndex','1000').
load('t361','style_R_41','width').
store('style_R_41','width','""20px""').
load('t362','style_R_41','height').
store('style_R_41','height','""20px""').
load('t363','Image_R_?','src').
store('Image_R_?','src','url_R_41').
assign('isLink_R_42','false').
load('t364','e_R_42','target').
assign('elem_R_42','t364').
load('t365','{"regexp": "input|textarea", "modifiers": "i"}','test_R_?').
load('t366','elem_R_42','nodeName').
actual('103','1','t366').
callRet('103','t366').
assign('linux_R_42','t368').
load('t369','elem_R_42','parentNode').
assign('elem_R_42','t369').
actual('104','1','elem_R_42').
callRet('104','elem_R_42').
actual('104','2','a').
callRet('104','a').
assign('isLink_R_42','t370').
assign('t371','isLink_R_42').
load('t372','e_R_42','target').
actual('105','1','t372').
callRet('105','t372').
assign('elem_R_42','t373').
assign('t375','elem_R_42').
assign('t376','enabled_R_39').
load('t378','e_R_42','button').
assign('t374','t382').
methodRet('d_mousedown_R_42','true').
load('t384','e_R_42','preventDefault_R_?').
assign('t383','t385').
assign('t386','scrolling_R_39').
methodRet('d_mousedown_R_42','false').
assign('scrolling_R_39','true').
load('t387','img_R_39','style').
load('t388','t387','left').
load('t389','e_R_42','clientX').
store('t387','left','t391').
load('t392','img_R_39','style').
load('t393','t392','top').
load('t394','e_R_42','clientY').
store('t392','top','t396').
load('t398','document','body').
load('t399','t398','appendChild_R_?').
actual('107','1','img_R_39').
callRet('107','img_R_39').
assign('t397','t400').
load('t401','e_R_42','clientX').
assign('refereceX_R_42','t401').
load('t402','e_R_42','clientY').
assign('refereceY_R_42','t402').
assign('speedX_R_42','0').
assign('speedY_R_42','0').
ptsTo('t403','n_Date_R_?_3').
prototype('n_Date_R_?_3', 'p_Date_R_?').
assign('last_R_42','t403').
assign('delay_R_42','t404').
assign('finished_R_42','false').
actual('108','1','step_R_43').
callRet('108','step_R_43').
actual('108','2','elem_R_42').
callRet('108','elem_R_42').
actual('108','3','delay_R_42').
callRet('108','delay_R_42').
assign('t405','t406').
ptsTo('step_R_43','d_step_R_43').
heapPtsTo('d_step_R_43','prototype','p_step_R_43').
prototype('p_step_R_43','h_FP').
methodRet('d_step_R_43','step_R_43').
assign('first_R_42','true').
ptsTo('mousemove_R_44','d_mousemove_R_44').
heapPtsTo('d_mousemove_R_44','prototype','p_mousemove_R_44').
prototype('p_mousemove_R_44','h_FP').
methodRet('d_mousemove_R_44','mousemove_R_44').
formal('d_mousemove_R_44','1','e_R_44').
ptsTo('remove_R_45','d_remove_R_45').
heapPtsTo('d_remove_R_45','prototype','p_remove_R_45').
prototype('p_remove_R_45','h_FP').
methodRet('d_remove_R_45','remove_R_45').
formal('d_remove_R_45','1','e_R_45').
actual('109','1','mousemove').
callRet('109','mousemove').
actual('109','2','mousemove_R_?').
callRet('109','mousemove_R_?').
assign('t407','t408').
actual('110','1','mousedown').
callRet('110','mousedown').
actual('110','2','remove_R_?').
callRet('110','remove_R_?').
assign('t409','t410').
actual('111','1','keydown').
callRet('111','keydown').
actual('111','2','remove_R_?').
callRet('111','remove_R_?').
assign('t411','t412').
ptsTo('t413','n_Date_R_?_4').
prototype('n_Date_R_?_4', 'p_Date_R_?').
assign('now_R_43','t413').
assign('elapsed_R_43','t414').
load('t415','elem_R_42','scrollLeft').
store('elem_R_42','scrollLeft','t417').
load('t418','elem_R_42','scrollTop').
store('elem_R_42','scrollTop','t420').
assign('last_R_42','now_R_43').
assign('t422','finished_R_42').
assign('t421','t422').
actual('112','1','step_R_?').
callRet('112','step_R_?').
actual('112','2','elem_R_42').
callRet('112','elem_R_42').
actual('112','3','delay_R_42').
callRet('112','delay_R_42').
assign('t423','t424').
assign('t425','first_R_42').
actual('113','1','mouseup').
callRet('113','mouseup').
actual('113','2','remove_R_?').
callRet('113','remove_R_?').
assign('t426','t427').
assign('first_R_42','false').
load('t428','e_R_44','clientX').
assign('speedX_R_42','t431').
load('t432','e_R_44','clientY').
assign('speedY_R_42','t435').
actual('114','1','mousemove').
callRet('114','mousemove').
actual('114','2','mousemove_R_?').
callRet('114','mousemove_R_?').
assign('t436','t437').
actual('115','1','mousedown').
callRet('115','mousedown').
actual('115','2','remove_R_?').
callRet('115','remove_R_?').
assign('t438','t439').
actual('116','1','mouseup').
callRet('116','mouseup').
actual('116','2','remove_R_?').
callRet('116','remove_R_?').
assign('t440','t441').
actual('117','1','keydown').
callRet('117','keydown').
actual('117','2','remove_R_?').
callRet('117','remove_R_?').
assign('t442','t443').
load('t445','document','body').
load('t446','t445','removeChild_R_?').
actual('118','1','img_R_39').
callRet('118','img_R_39').
assign('t444','t447').
assign('scrolling_R_39','false').
assign('finished_R_42','true').
load('t448','settings_R_46','framerate').
assign('framerate_R_0','t448').
load('t449','settings_R_46','animtime').
assign('animtime_R_0','t449').
load('t450','settings_R_46','scrollsz').
assign('stepsize_R_0','t450').
load('t451','settings_R_46','accelMax').
assign('accelMax_R_0','t451').
load('t452','settings_R_46','accelDelta').
assign('accelDelta_R_0','t452').
load('t453','settings_R_46','exclude').
assign('exclude_R_0','t453').
load('t454','settings_R_46','pulseAlgorithm').
assign('pulseAlgorithm_R_0','t455').
load('t456','settings_R_46','pulseScale').
assign('pulseScale_R_0','t456').
load('t457','settings_R_46','keyboardsupport').
assign('keyboardsupport_R_0','t458').
load('t459','settings_R_46','arrscroll').
assign('arrowscroll_R_0','t459').
load('t460','settings_R_46','fixedback').
assign('fixedback_R_0','t461').
assign('t462','t463').
assign('t465','disableKeyboard_R_0').
assign('t464','t466').
actual('120','1','keydown').
callRet('120','keydown').
actual('120','2','keydown_R_?').
callRet('120','keydown_R_?').
assign('t467','t468').
assign('t470','framerate_R_0').
assign('t469','t470').
actual('121','1','SmoothScroll: Please restart Chrome').
callRet('121','SmoothScroll: Please restart Chrome').
assign('t471','t472').
load('t474','document','URL').
load('t475','t474','indexOf_R_?').
actual('122','1','google.com/reader/view').
callRet('122','google.com/reader/view').
assign('t477','1').
assign('t473','t478').
assign('disableKeyboard_R_0','true').
assign('t479','exclude_R_0').
load('t480','exclude_R_0','split_R_?').
actual('123','1','{"regexp": "[,\\n] ?", "modifiers": ""}').
callRet('123','{"regexp": "[,\\n] ?", "modifiers": ""}').
assign('domains_R_47','t481').
assign('t483','i_R_47').
assign('t482','t483').
load('t484','domains_R_47','length').
assign('i_R_47','t484').
load('t486','document','URL').
load('t487','t486','indexOf').
load('t488','domains_R_47','i_R_47').
actual('124','1','t488').
callRet('124','t488').
assign('t490','1').
assign('t485','t491').
actual('125','1','mousewheel').
callRet('125','mousewheel').
actual('125','2','wheel_R_?').
callRet('125','wheel_R_?').
assign('t492','t493').
assign('disableKeyboard_R_0','true').
assign('disabled_R_0','true').
load('t494','domains_R_47','length').
assign('i_R_47','t494').
assign('t495','disableKeyboard_R_0').
actual('126','1','keydown').
callRet('126','keydown').
actual('126','2','keydown_R_?').
callRet('126','keydown_R_?').
assign('t496','t497').
load('t499','document','body').
assign('t500','t499').
assign('t498','t500').
methodRet('d_init_R_48','null').
load('t501','document','body').
assign('body_R_48','t501').
load('t502','document','documentElement').
assign('html_R_48','t502').
load('t503','window','innerHeight').
assign('windowHeight_R_48','t503').
load('t504','body_R_48','scrollHeight').
assign('scrollHeight_R_48','t504').
load('t505','document','compatMode').
load('t506','t505','indexOf_R_?').
actual('127','1','CSS').
callRet('127','CSS').
assign('(None, "root_R_0")','html_R_48').
assign('root_R_0','body_R_48').
assign('activeElement_R_0','body_R_48').
assign('t509','t510').
assign('initdone_R_0','true').
assign('t511','t512').
load('t515','body_R_48','offsetHeight').
load('t517','html_R_48','offsetHeight').
assign('t513','t520').
assign('pending_R_48','false').
assign('refresh_R_48','lambda_R_49').
...
load('t521','html_R_48','style').
load('t522','t521','height').
store('t521','height','auto').
actual('129','1','refresh_R_48').
callRet('129','refresh_R_48').
actual('129','2','10').
callRet('129','10').
assign('t523','t524').
actual('130','1','DOMNodeInserted').
callRet('130','DOMNodeInserted').
actual('130','2','refresh_R_48').
callRet('130','refresh_R_48').
assign('t525','t526').
actual('131','1','DOMNodeRemoved').
callRet('131','DOMNodeRemoved').
actual('131','2','refresh_R_48').
callRet('131','refresh_R_48').
assign('t527','t528').
load('t530','root_R_0','offsetHeight').
assign('t529','t531').
load('t532','document','createElement_R_?').
actual('132','1','div').
callRet('132','div').
assign('underlay_R_48','t533').
load('t534','underlay_R_48','style').
load('t535','t534','clear').
store('t534','clear','both').
load('t537','body_R_48','appendChild_R_?').
actual('133','1','underlay_R_48').
callRet('133','underlay_R_48').
assign('t536','t538').
assign('frame_R_0','true').
load('t540','document','URL').
load('t541','t540','indexOf').
actual('134','1','mail.google.com').
callRet('134','mail.google.com').
assign('t543','1').
assign('t539','t544').
load('t545','document','createElement').
actual('135','1','style').
callRet('135','style').
assign('s_R_48','t546').
load('t547','s_R_48','innerHTML').
store('s_R_48','innerHTML','.iu { visibility: hidden }').
load('t549','document','getElementsByTagName_R_?').
actual('136','1','head').
callRet('136','head').
load('t551','t550','0').
load('t553','t552','appendChild').
actual('137','1','s_R_48').
callRet('137','s_R_48').
assign('t548','t554').
assign('t556','fixedback_R_0').
assign('t557','disabled_R_0').
assign('t555','t558').
load('t559','body_R_48','style').
load('t560','t559','backgroundAttachment').
store('t559','backgroundAttachment','scroll').
load('t561','html_R_48','style').
load('t562','t561','backgroundAttachment').
store('t561','backgroundAttachment','scroll').
assign('t564','pending_R_48').
load('t565','html_R_48','scrollHeight').
load('t566','document','height').
assign('t563','t568').
assign('pending_R_48','true').
actual('138','1','lambda_R_50').
callRet('138','lambda_R_50').
actual('138','2','500').
callRet('138','500').
assign('t569','t570').
...
load('t571','html_R_48','style').
load('t572','t571','height').
load('t573','document','height').
store('t571','height','t574').
assign('pending_R_48','false').
assign('delay_R_51','1000').
assign('t575','t576').
actual('139','1','left_R_51').
callRet('139','left_R_51').
actual('139','2','top_R_51').
callRet('139','top_R_51').
assign('t577','t578').
assign('t579','acceleration_R_0').
ptsTo('t580','n_Date_R_?_5').
prototype('n_Date_R_?_5', 'p_Date_R_?').
assign('now_R_51','t580').
assign('elapsed_R_51','t581').
assign('t582','t583').
assign('factor_R_51','t586').
assign('t587','t588').
load('t589','Math_R_?','min_R_?').
actual('140','1','factor_R_51').
callRet('140','factor_R_51').
actual('140','2','accelMax_R_0').
callRet('140','accelMax_R_0').
assign('factor_R_51','t590').
assign('left_R_51','factor_R_51').
assign('top_R_51','factor_R_51').
ptsTo('t591','n_Date_R_?_6').
prototype('n_Date_R_?_6', 'p_Date_R_?').
assign('lastScroll_R_0','t591').
load('t593','que_R_0','push_R_?').
store('t594','x_R_?','left_R_51').
store('t594','y_R_?','top_R_51').
assign('t596','0.99').
assign('None','0.99').
store('t594','lastX_R_?','t596').
assign('t598','0.99').
assign('None','0.99').
store('t594','lastY_R_?','t598').
ptsTo('t599','n_Date_R_?_7').
prototype('n_Date_R_?_7', 'p_Date_R_?').
store('t594','start_R_?','t599').
actual('141','1','t594').
callRet('141','t594').
assign('t592','t600').
assign('t601','pending_R_0').
methodRet('d_scrollArray_R_51','null').
load('t602','document','body').
assign('scrollWindow_R_51','t603').
assign('step_R_51','lambda_R_52').
...
actual('142','1','step_R_51').
callRet('142','step_R_51').
actual('142','2','elem_R_51').
callRet('142','elem_R_51').
actual('142','3','0').
callRet('142','0').
assign('t604','t605').
assign('pending_R_0','true').
ptsTo('t606','n_Date_R_?_8').
prototype('n_Date_R_?_8', 'p_Date_R_?').
assign('now_R_52','t606').
assign('scrollX_R_52','0').
assign('scrollY_R_52','0').
load('t608','que_R_0','length').
assign('t607','t609').
assign('i_R_52','0').
assign('t611','i_R_52').
assign('t610','t611').
load('t612','que_R_0','i_R_52').
assign('item_R_52','t612').
load('t613','item_R_52','start').
assign('elapsed_R_52','t614').
assign('finished_R_52','t615').
assign('(None, "position_R_52")','1').
assign('position_R_52','t616').
assign('t617','pulseAlgorithm_R_0').
actual('143','1','position_R_52').
callRet('143','position_R_52').
assign('position_R_52','t618').
load('t619','item_R_52','x').
load('t621','item_R_52','lastX').
assign('x_R_52','t623').
load('t624','item_R_52','y').
load('t626','item_R_52','lastY').
assign('y_R_52','t628').
assign('scrollX_R_52','x_R_52').
assign('scrollY_R_52','y_R_52').
load('t629','item_R_52','lastX').
store('item_R_52','lastX','x_R_52').
load('t630','item_R_52','lastY').
store('item_R_52','lastY','y_R_52').
assign('t631','finished_R_52').
load('t633','que_R_0','splice_R_?').
actual('144','1','i_R_52').
callRet('144','i_R_52').
actual('144','2','1').
callRet('144','1').
...
assign('t635','t636').
assign('i_R_52','0').
assign('t637','scrollWindow_R_51').
assign('t638','scrollX_R_52').
load('t639','elem_R_51','scrollLeft').
store('elem_R_51','scrollLeft','scrollX_R_52').
assign('t640','scrollY_R_52').
load('t641','elem_R_51','scrollTop').
store('elem_R_51','scrollTop','scrollY_R_52').
load('t643','window','scrollBy_R_?').
actual('145','1','scrollX_R_52').
callRet('145','scrollX_R_52').
actual('145','2','scrollY_R_52').
callRet('145','scrollY_R_52').
assign('t642','t644').
assign('t646','left_R_51').
assign('t647','top_R_51').
assign('t645','t648').
assign('que_R_0','que_R_0').
load('t650','que_R_0','length').
assign('t649','t650').
assign('pending_R_0','false').
actual('146','1','step_R_51').
callRet('146','step_R_51').
actual('146','2','elem_R_51').
callRet('146','elem_R_51').
actual('146','3','t653').
callRet('146','t653').
assign('t651','t654').
assign('t656','initdone_R_0').
assign('t655','t656').
assign('t657','t658').
load('t659','event_R_53','target').
assign('target_R_53','t659').
actual('148','1','target_R_53').
callRet('148','target_R_53').
assign('overflowing_R_53','t660').
assign('t662','overflowing_R_53').
load('t663','event_R_53','defaultPrevented').
actual('149','1','activeElement_R_0').
callRet('149','activeElement_R_0').
actual('149','2','embed').
callRet('149','embed').
actual('150','1','target_R_53').
callRet('150','target_R_53').
actual('150','2','embed').
callRet('150','embed').
load('t668','{"regexp": "\\.pdf", "modifiers": "i"}','test_R_?').
load('t669','target_R_53','src').
actual('151','1','t669').
callRet('151','t669').
assign('t661','t672').
methodRet('d_wheel_R_53','true').
load('t673','event_R_53','wheelDeltaX').
assign('deltaX_R_53','t674').
load('t675','event_R_53','wheelDeltaY').
assign('deltaY_R_53','t676').
assign('t678','deltaX_R_53').
assign('t679','deltaY_R_53').
assign('t677','t680').
load('t681','event_R_53','wheelDelta').
assign('deltaY_R_53','t682').
load('t684','Math_R_?','abs_R_?').
actual('152','1','deltaX_R_53').
callRet('152','deltaX_R_53').
assign('t683','t686').
assign('deltaX_R_53','t687').
load('t689','Math_R_?','abs').
actual('153','1','deltaY_R_53').
callRet('153','deltaY_R_53').
assign('t688','t691').
assign('deltaY_R_53','t692').
assign('t694','deltaX_R_53').
assign('t695','deltaY_R_53').
actual('154','1','overflowing_R_53').
callRet('154','overflowing_R_53').
actual('154','2','t694').
callRet('154','t694').
actual('154','3','t695').
callRet('154','t695').
assign('t693','t696').
load('t698','event_R_53','preventDefault_R_?').
assign('t697','t699').
load('t700','event_R_54','target').
assign('target_R_54','t700').
load('t701','event_R_54','ctrlKey').
load('t702','event_R_54','altKey').
load('t704','event_R_54','metaKey').
load('t706','event_R_54','shiftKey').
load('t707','event_R_54','keyCode').
load('t708','key_R_0','spacebar').
assign('modifier_R_54','t711').
load('t713','{"regexp": "input|textarea|select|embed", "modifiers": "i"}','test_R_?').
load('t714','target_R_54','nodeName').
actual('156','1','t714').
callRet('156','t714').
load('t716','target_R_54','isContentEditable').
load('t718','event_R_54','defaultPrevented').
assign('t712','t720').
methodRet('d_keydown_R_54','true').
actual('157','1','target_R_54').
callRet('157','target_R_54').
actual('157','2','button').
callRet('157','button').
load('t723','event_R_54','keyCode').
load('t724','key_R_0','spacebar').
assign('t721','t726').
methodRet('d_keydown_R_54','true').
assign('shift_R_54','__undefined__').
assign('x_R_?','0').
assign('y_R_?','0').
actual('158','1','activeElement_R_0').
callRet('158','activeElement_R_0').
assign('elem_R_54','t727').
load('t728','elem_R_54','clientHeight').
assign('clientHeight_R_54','t728').
load('t730','document','body').
assign('t729','t731').
load('t732','window','innerHeight').
assign('clientHeight_R_54','t732').
actual('159','1','elem_R_54').
callRet('159','elem_R_54').
actual('159','2','x_R_?').
callRet('159','x_R_?').
actual('159','3','y_R_?').
callRet('159','y_R_?').
assign('t733','t734').
load('t736','event_R_54','preventDefault_R_?').
assign('t735','t737').
load('t738','event_R_55','target').
assign('activeElement_R_0','t738').
assign('cache_R_0','__objectInit__').
assign('i_R_57','0').
methodRet('d_lambda_R_57','lambda_R_58').
...
formal('d_lambda_R_58','1','el_R_58').
load('t739','el_R_58','uniqueID').
load('t740','el_R_58','uniqueID').
assign('t741','i_R_57').
assign('t740','t741').
methodRet('d_lambda_R_58','t742').
assign('t744','i_R_59').
assign('t743','t744').
load('t745','elems_R_59','length').
assign('i_R_59','t745').
load('t746','cache_R_0','uniqueID_R_?').
load('t747','t746','elems_R_59').
load('t748','t747','i_R_59').
store('t747','i_R_59','overflowing_R_59').
load('t749','elems_R_59','length').
assign('i_R_59','t749').
methodRet('d_setCache_R_59','overflowing_R_59').
assign('elems_R_60','elems_R_60').
load('t750','root_R_0','scrollHeight').
assign('rootScrollHeight_R_60','t750').
load('t751','el_R_60','parentNode').
assign('el_R_60','t751').
actual('161','1','el_R_60').
callRet('161','el_R_60').
load('t753','cache_R_0','t752').
assign('cached_R_60','t753').
assign('t754','cached_R_60').
actual('162','1','elems_R_60').
callRet('162','elems_R_60').
actual('162','2','cached_R_60').
callRet('162','cached_R_60').
methodRet('d_overflowingAncestor_R_60','t755').
load('t757','elems_R_60','push_R_?').
actual('163','1','el_R_60').
callRet('163','el_R_60').
assign('t756','t758').
load('t760','el_R_60','scrollHeight').
assign('t759','t761').
load('t763','el_R_60','clientHeight').
load('t765','el_R_60','scrollHeight').
assign('t762','t766').
actual('164','1','el_R_60').
callRet('164','el_R_60').
actual('164','2','').
callRet('164','None').
load('t768','t767','getPropertyValue_R_?').
actual('165','1','overflow-y').
callRet('165','overflow-y').
assign('overflow_R_?','t769').
assign('t770','t773').
actual('166','1','elems_R_60').
callRet('166','elems_R_60').
actual('166','2','el_R_60').
callRet('166','el_R_60').
methodRet('d_overflowingAncestor_R_60','t774').
assign('t776','frame_R_0').
load('t777','root_R_0','clientHeight').
assign('t775','t780').
load('t781','document','body').
actual('167','1','elems_R_60').
callRet('167','elems_R_60').
actual('167','2','t781').
callRet('167','t781').
methodRet('d_overflowingAncestor_R_60','t782').
load('t784','window','addEventListener_R_?').
actual('168','1','type_R_61').
callRet('168','type_R_61').
actual('168','2','fn_R_61').
callRet('168','fn_R_61').
actual('168','3','t785').
callRet('168','t785').
assign('t783','t786').
load('t788','window','removeEventListener_R_?').
actual('169','1','type_R_62').
callRet('169','type_R_62').
actual('169','2','fn_R_62').
callRet('169','fn_R_62').
actual('169','3','t789').
callRet('169','t789').
assign('t787','t790').
load('t791','el_R_63','nodeName').
load('t793','t792','toLowerCase_R_?').
load('t795','tag_R_63','toLowerCase').
methodRet('d_isNodeName_R_63','t797').
assign('t799','1').
assign('(None, "x_R_64")','1').
assign('x_R_64','t799').
assign('t801','1').
assign('(None, "y_R_64")','1').
assign('y_R_64','t801').
load('t803','direction_R_0','x').
load('t805','direction_R_0','y').
assign('t802','t807').
load('t808','direction_R_0','x').
store('direction_R_0','x','x_R_64').
load('t809','direction_R_0','y').
store('direction_R_0','y','y_R_64').
assign('que_R_0','que_R_0').
assign('lastScroll_R_0','0').
load('t810','window','requestAnimationFrame').
load('t811','window','webkitRequestAnimationFrame').
methodRet('d_lambda_R_65','t813').
...
formal('d_lambda_R_66','1','callback_R_66').
formal('d_lambda_R_66','2','element_R_66').
formal('d_lambda_R_66','3','delay_R_66').
load('t815','window','setTimeout_R_?').
actual('172','1','callback_R_66').
callRet('172','callback_R_66').
actual('172','2','t817').
callRet('172','t817').
assign('t814','t818').
assign('val_R_67','__undefined__').
assign('start_R_?','__undefined__').
assign('expx_R_?','__undefined__').
assign('x_R_67','t819').
assign('t820','t821').
load('t822','Math_R_?','exp_R_?').
assign('t823','1').
actual('173','1','t823').
callRet('173','t823').
assign('start_R_?','t824').
assign('x_R_67','1').
load('t825','Math_R_?','exp').
assign('t826','x_R_67').
actual('174','1','t826').
callRet('174','t826').
assign('expx_R_?','t828').
assign('val_R_67','t831').
load('t832','Math_R_?','exp').
assign('t833','x_R_67').
actual('175','1','t833').
callRet('175','t833').
assign('val_R_67','t836').
methodRet('d_pulse__R_67','t837').
assign('t838','t839').
methodRet('d_pulse_R_68','1').
assign('t840','t841').
methodRet('d_pulse_R_68','0').
assign('t842','t843').
actual('176','1','1').
callRet('176','1').
assign('pulseNormalize_R_0','t844').
actual('177','1','x_R_68').
callRet('177','x_R_68').
methodRet('d_pulse_R_68','t845').
% basicrules.pl
