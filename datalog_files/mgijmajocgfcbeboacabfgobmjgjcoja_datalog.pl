assign('a_R_0','null').
assign('g_R_?','t0').
assign('t1','LEAPFROG_MODE_R_?').
load('t3','tblf_R_?','module').
load('t4','t3','provide_R_?').
actual('0','1','tblf.translationary').
callRet('0','tblf.translationary').
load('t6','tblf_R_?','B').
assign('t6','g_R_?').
assign('t2','t6').
load('t7','g_R_?','v').
...
store('t15','45','your').
store('g_R_?','j','t15').
load('t16','g_R_?','options').
store('g_R_?','options','__objectInit__').
load('t17','g_R_?','A').
store('g_R_?','A','0').
load('t18','g_R_?','g').
store('g_R_?','g','a_R_0').
...
formal('d_lambda_R_1','1','b_R_1').
load('t22','g_R_?','contains').
store('g_R_?','contains','lambda_R_2').
...
formal('d_lambda_R_2','2','d_R_2').
load('t23','g_R_?','a').
store('g_R_?','a','lambda_R_3').
...
formal('d_lambda_R_3','1','b_R_3').
load('t24','g_R_?','t').
store('g_R_?','t','lambda_R_4').
...
formal('d_lambda_R_5','2','d_R_5').
formal('d_lambda_R_5','3','c_R_5').
load('t26','g_R_?','s').
store('g_R_?','s','lambda_R_6').
...
formal('d_lambda_R_6','2','d_R_6').
formal('d_lambda_R_6','3','c_R_6').
load('t27','g_R_?','q').
store('g_R_?','q','lambda_R_7').
...
formal('d_lambda_R_7','2','d_R_7').
formal('d_lambda_R_7','3','c_R_7').
load('t28','g_R_?','o').
store('g_R_?','o','lambda_R_13').
...
formal('d_lambda_R_13','2','d_R_13').
load('t29','g_R_?','k').
store('g_R_?','k','lambda_R_15').
...
formal('d_lambda_R_15','1','b_R_15').
load('t30','g_R_?','c').
store('g_R_?','c','lambda_R_16').
...
formal('d_lambda_R_16','1','b_R_16').
formal('d_lambda_R_16','2','d_R_16').
formal('d_lambda_R_16','3','c_R_16').
load('t31','g_R_?','h').
store('g_R_?','h','lambda_R_17').
...
formal('d_lambda_R_17','1','b_R_17').
formal('d_lambda_R_17','2','d_R_17').
load('t32','g_R_?','d').
store('g_R_?','d','lambda_R_19').
...
formal('d_lambda_R_19','1','b_R_19').
formal('d_lambda_R_19','2','d_R_19').
load('t33','g_R_?','i').
store('g_R_?','i','lambda_R_20').
...
formal('d_lambda_R_20','1','b_R_20').
load('t34','g_R_?','l').
store('g_R_?','l','lambda_R_21').
...
formal('d_lambda_R_22','1','b_R_22').
load('t36','g_R_?','m').
store('g_R_?','m','lambda_R_23').
...
assign('i_R_?','lambda_R_25').
assign('k_R_?','lambda_R_26').
assign('o_R_?','lambda_R_28').
assign('q_R_?','lambda_R_29').
assign('r_R_?','lambda_R_30').
assign('u_R_?','{"regexp": "[0-9A-Za-z]", "modifiers": ""}').
assign('B_R_?','lambda_R_31').
assign('C_R_?','C_R_?').
load('t42','chrome','extension').
load('t43','t42','getURL').
actual('4','1','options.html').
callRet('4','options.html').
assign('x_R_?','t46').
...
formal('d_lambda_R_26','1','a_R_26').
formal('d_lambda_R_26','2','b_R_26').
...
load('t74','f_R_?','z').
store('f_R_?','z','d_R_0').
assign('z_R_0','lambda_R_33').
assign('D_R_?','lambda_R_34').
assign('F_R_?','lambda_R_35').
assign('v_R_?','lambda_R_36').
assign('y_R_?','lambda_R_37').
assign('G_R_?','lambda_R_38').
assign('H_R_?','lambda_R_39').
...
load('t75','B_R_?','prototype').
load('t76','t75','L').
store('t75','L','lambda_R_40').
...
assign('I_R_0','lambda_R_41').
assign('J_R_?','lambda_R_42').
...
formal('d_lambda_R_42','2','b_R_42').
load('t77','B_R_?','prototype').
load('t78','t77','k').
store('t77','k','lambda_R_43').
...
load('t79','B_R_?','prototype').
load('t80','t79','J').
store('t79','J','lambda_R_44').
...
assign('K_R_0','lambda_R_45').
assign('M_R_?','lambda_R_46').
assign('N_R_?','lambda_R_47').
...
formal('d_lambda_R_47','2','b_R_47').
formal('d_lambda_R_47','3','c_R_47').
formal('d_lambda_R_47','4','g_R_47').
load('t81','B_R_?','prototype').
load('t82','t81','K').
store('t81','K','lambda_R_49').
...
load('t83','B_R_?','prototype').
load('t84','t83','H').
store('t83','H','lambda_R_51').
...
formal('d_lambda_R_53','3','c_R_53').
load('t85','B_R_?','prototype').
load('t86','t85','I').
store('t85','I','lambda_R_54').
...
assign('_dictBubbleInstance_R_0','__undefined__').
actual('5','1','_dictBubbleInstance_R_0').
callRet('5','_dictBubbleInstance_R_0').
assign('t87','t89').
assign('_gdxBubbleInstance_R_0','__undefined__').
actual('6','1','_gdxBubbleInstance_R_0').
callRet('6','_gdxBubbleInstance_R_0').
assign('t90','t92').
load('t95','tblf_R_?','contentScriptUtil').
load('t98','tblf_R_?','contentScriptUtil').
load('t99','t98','preventContentScripts_R_?').
assign('t101','1').
assign('t93','t103').
ptsTo('t104','n_B_R_?_0').
prototype('n_B_R_?_0', 'p_B_R_?').
assign('_gdxBubbleInstance_R_0','t104').
assign('_gaq_R_0','t105').
load('t107','_gaq_R_0','push_R_?').
store('t108','0','_setAccount').
store('t108','1','UA-23514435-1').
actual('8','1','t108').
callRet('8','t108').
assign('t106','t109').
load('t111','_gaq_R_0','push').
store('t112','0','_trackPageview').
actual('9','1','t112').
callRet('9','t112').
assign('t110','t113').
assign('t114','t115').
...
load('t116','window','gdx.LANG_MAP').
store('t116','ar_R_?','Arabic').
store('t116','ca_R_?','Catalan').
store('t116','cs_R_?','Czech').
store('t116','da_R_?','Danish').
store('t116','de_R_?','German').
store('t116','el_R_?','Greek').
store('t116','en_R_?','English').
store('t116','es_R_?','Spanish').
store('t116','fi_R_?','Finnish').
store('t116','fr_R_?','French').
store('t116','hi_R_?','Hindi').
store('t116','hr_R_?','Croatian').
store('t116','id_R_?','Indonesian').
store('t116','it_R_?','Italian').
store('t116','iw_R_?','Hebrew').
store('t116','ja_R_?','Japanese').
store('t116','ko_R_?','Korean').
store('t116','nl_R_?','Dutch').
store('t116','no_R_?','Norwegian').
store('t116','pl_R_?','Polish').
store('t116','pt-br','Portuguese').
store('t116','pt-pt','Portuguese').
store('t116','pt_R_?','Portuguese').
store('t116','ro_R_?','Romanian').
store('t116','ru_R_?','Russian').
store('t116','sr_R_?','Serbian').
store('t116','sv_R_?','Swedish').
store('t116','th_R_?','Thai').
store('t116','tl_R_?','Tagalog').
store('t116','tr_R_?','Turkish').
store('t116','uk_R_?','Ukrainian').
store('t116','vi_R_?','Vietnamese').
store('t116','zh-cn','Chinese').
store('t116','zh-tw','Chinese').
store('t116','zh_R_?','Chinese').
store('window','gdx.LANG_MAP','__objectInit__').
assign('d_R_0','__undefined__').
...
assign('n_R_?','lambda_R_56').
assign('r_R_?','lambda_R_58').
assign('o_R_?','lambda_R_59').
assign('m_R_?','lambda_R_60').
assign('s_R_?','lambda_R_61').
assign('p_R_?','lambda_R_62').
assign('q_R_?','lambda_R_63').
assign('_initOptionsPage_R_?','lambda_R_64').
...
assign('h_R_?','__undefined__').
assign('i_R_?','__undefined__').
assign('j_R_?','lambda_R_67').
assign('m_R_?','lambda_R_69').
assign('k_R_?','lambda_R_70').
assign('_initDictPageAction_R_?','lambda_R_72').
...
callRet('14','None').
assign('b_R_1','t126').
load('t127','b_R_1','substring_R_?').
load('t128','g_R_?','v').
actual('15','1','0').
callRet('15','0').
actual('15','2','t128').
callRet('15','t128').
load('t130','t129','toLowerCase_R_?').
assign('b_R_1','t131').
methodRet('d_lambda_R_1','b_R_1').
assign('t132','t133').
assign('c_R_2','0').
load('t134','b_R_2','length').
assign('e_R_?','t134').
assign('t136','c_R_2').
assign('t135','t136').
load('t138','b_R_2','c_R_2').
assign('t137','t139').
assign('t140','0').
methodRet('d_lambda_R_2','t140').
assign('c_R_2','0').
load('t141','b_R_2','length').
assign('e_R_?','t141').
assign('t142','1').
methodRet('d_lambda_R_2','t142').
load('t143','JSON_R_?','stringify_R_?').
actual('17','1','b_R_3').
callRet('17','b_R_3').
actual('17','2','a_R_0').
callRet('17','a_R_0').
actual('17','3','  ').
callRet('17','  ').
methodRet('d_lambda_R_3','t144').
load('t145','g_R_?','options').
load('t146','JSON_R_?','parse_R_?').
load('t147','window','localStorage').
load('t148','t147','options').
actual('18','1','t148').
callRet('18','t148').
store('g_R_?','options','t149').
load('t151','b_R_5','type').
load('t154','g_R_?','A').
assign('t155','t154').
store('t153','instanceId_R_?','t155').
assign('None','LEAPFROG_SERVER_URL_R_?').
store('t153','leapfrogServerUrl_R_?','').
assign('b_R_5','t153').
actual('19','1','b_R_5').
callRet('19','b_R_5').
assign('t150','t157').
load('t159','b_R_6','type').
assign('t158','t160').
store('t162','language_R_?','en').
assign('b_R_6','t162').
load('t163','b_R_6','popupDblclick').
load('t164','tblf_R_?','localStorage').
load('t165','t164','getItem_R_?').
actual('20','1','pref-translationary-enable').
callRet('20','pref-translationary-enable').
assign('t163','t167').
load('t168','b_R_6','popupDblclickKey').
assign('t168','none').
load('t169','b_R_6','enableHttps').
load('t170','tblf_R_?','localStorage').
load('t171','t170','getItem').
actual('21','1','pref-translationary-enable-https').
callRet('21','pref-translationary-enable-https').
assign('t169','t173').
store('t174','options_R_?','b_R_6').
actual('22','1','t174').
callRet('22','t174').
load('t177','g_R_?','options').
store('t176','options_R_?','t177').
actual('23','1','t176').
callRet('23','t176').
assign('None','t175').
assign('t161','t178').
load('t180','b_R_7','type').
load('t182','b_R_7','type').
assign('t185','t184').
assign('t179','t185').
load('t187','_gaq_R_0','push_R_?').
store('t188','0','_trackEvent').
store('t188','1','lookup').
load('t189','b_R_7','type').
store('t188','2','t189').
actual('24','1','t188').
callRet('24','t188').
assign('t186','t190').
load('t192','g_R_?','g').
load('t194','g_R_?','f').
load('t195','b_R_7','instanceId').
load('t198','chrome','tabs').
load('t199','t198','sendRequest').
load('t200','g_R_?','g').
load('t201','t200','id').
store('t202','type_R_?','hide').
load('t203','g_R_?','f').
store('t202','instanceId_R_?','t203').
actual('25','1','t201').
callRet('25','t201').
actual('25','2','t202').
callRet('25','t202').
...
store('g_R_?','g','t207').
load('t208','g_R_?','f').
load('t209','b_R_7','instanceId').
store('g_R_?','f','t209').
load('t210','g_R_?','p_R_?').
load('t211','b_R_7','query').
actual('26','1','t211').
callRet('26','t211').
assign('d_R_7','t212').
store('e_R_?','request_R_?','b_R_7').
store('e_R_?','sanitizedQuery_R_?','d_R_7').
store('e_R_?','dictResponse_R_?','a_R_0').
store('e_R_?','translateResponse_R_?','a_R_0').
store('e_R_?','numResponses_R_?','0').
store('e_R_?','callback_R_?','c_R_7').
assign('e_R_?','__objectInit__').
assign('c_R_7','pr,de').
load('t214','b_R_7','type').
assign('c_R_7','pr,de,sy').
assign('t213','t216').
load('t218','google_R_?','language').
load('t219','t218','define_R_?').
load('t220','g_R_?','options').
load('t221','t220','language').
load('t222','g_R_?','options').
load('t223','t222','language').
store('t224','restricts_R_?','c_R_7').
actual('27','1','d_R_7').
callRet('27','d_R_7').
actual('27','2','t221').
callRet('27','t221').
actual('27','3','t223').
callRet('27','t223').
actual('27','4','lambda_R_8').
callRet('27','lambda_R_8').
actual('27','5','t224').
callRet('27','t224').
assign('t217','t225').
...
formal('d_lambda_R_8','1','b_R_8').
load('t227','g_R_?','o_R_?').
actual('28','1','d_R_7').
callRet('28','d_R_7').
actual('28','2','lambda_R_9').
callRet('28','lambda_R_9').
load('t229','chrome','tabs').
load('t230','t229','getSelected').
actual('29','1','a_R_0').
callRet('29','a_R_0').
actual('29','2','lambda_R_10').
callRet('29','lambda_R_10').
assign('t226','t232').
...
formal('d_lambda_R_10','1','b_R_10').
load('t234','g_R_?','c_R_7').
actual('30','1','b_R_8').
callRet('30','b_R_8').
actual('30','2','dict').
callRet('30','dict').
...
callRet('30','e_R_?').
assign('t233','t235').
load('t237','g_R_?','c_R_7').
actual('31','1','b_R_9').
callRet('31','b_R_9').
actual('31','2','translate').
callRet('31','translate').
actual('31','3','e_R_?').
callRet('31','e_R_?').
assign('t236','t238').
load('t240','window','setTimeout_R_?').
actual('32','1','lambda_R_11').
callRet('32','lambda_R_11').
actual('32','2','800').
callRet('32','800').
assign('t239','t241').
...
load('t243','chrome','tabs').
load('t244','t243','detectLanguage').
load('t245','b_R_10','id').
actual('33','1','t245').
callRet('33','t245').
actual('33','2','lambda_R_12').
callRet('33','lambda_R_12').
assign('t242','t246').
...
formal('d_lambda_R_12','1','b_R_12').
load('t248','g_R_?','c_R_7').
store('t249','lang_R_?','unknown').
actual('34','1','t249').
callRet('34','t249').
actual('34','2','tabLang').
callRet('34','tabLang').
...
callRet('34','e_R_?').
assign('t247','t250').
load('t252','g_R_?','c_R_7').
store('t253','lang_R_?','b_R_12').
actual('35','1','t253').
callRet('35','t253').
actual('35','2','tabLang').
callRet('35','tabLang').
...
callRet('35','e_R_?').
assign('t251','t254').
ptsTo('t255','n_XMLHttpRequest_R_?_1').
prototype('n_XMLHttpRequest_R_?_1', 'p_XMLHttpRequest_R_?').
assign('c_R_13','t255').
load('t257','c_R_13','open_R_?').
load('t258','g_R_?','b').
load('t261','g_R_?','options').
load('t262','t261','language').
assign('t266','0').
actual('36','1','GET').
callRet('36','GET').
actual('36','2','t265').
...
callRet('36','t266').
assign('t256','t267').
load('t268','c_R_13','onreadystatechange').
store('c_R_13','onreadystatechange','lambda_R_14').
...
load('t270','c_R_13','send_R_?').
assign('t269','t271').
load('t273','c_R_13','readyState').
assign('t272','t274').
load('t276','JSON_R_?','parse_R_?').
load('t277','c_R_13','responseText').
actual('38','1','t277').
callRet('38','t277').
actual('39','1','t278').
callRet('39','t278').
assign('t275','t279').
assign('t280','t281').
methodRet('d_lambda_R_15','iw').
methodRet('d_lambda_R_15','b_R_15').
assign('t282','t283').
assign('t284','t285').
load('t287','c_R_16','tabLang').
assign('t286','t287').
methodRet('d_lambda_R_16','null').
load('t288','c_R_16','tabLang').
load('t289','g_R_?','k_R_?').
load('t290','b_R_16','lang').
actual('40','1','t290').
callRet('40','t290').
store('c_R_16','tabLang','t291').
load('t292','c_R_16','translateResponse').
store('c_R_16','translateResponse','b_R_16').
load('t293','c_R_16','dictResponse').
store('c_R_16','dictResponse','b_R_16').
assign('b_R_16','3').
assign('b_R_16','1').
assign('t294','t295').
load('t297','c_R_16','numResponses').
assign('t298','t297').
assign('t296','t298').
load('t300','c_R_16','numResponses').
assign('t299','t301').
load('t302','g_R_?','l_R_?').
load('t303','c_R_16','dictResponse').
actual('41','1','t303').
callRet('41','t303').
assign('b_R_16','t304').
load('t305','g_R_?','h_R_16').
load('t306','c_R_16','translateResponse').
assign('t307','0').
actual('42','1','t306').
callRet('42','t306').
actual('42','2','t307').
...
assign('d_R_16','t308').
load('t310','g_R_?','e').
load('t311','console','log_R_?').
actual('43','1','dictResponse:').
callRet('43','dictResponse:').
load('t313','console','log').
load('t314','g_R_?','a_R_0').
load('t315','c_R_16','dictResponse').
actual('44','1','t315').
callRet('44','t315').
actual('45','1','t316').
callRet('45','t316').
load('t318','console','log').
actual('46','1','definitionObj:').
callRet('46','definitionObj:').
load('t320','console','log').
load('t321','g_R_?','a').
actual('47','1','b_R_16').
callRet('47','b_R_16').
actual('48','1','t322').
callRet('48','t322').
load('t324','console','log').
actual('49','1','translateResponse:').
callRet('49','translateResponse:').
load('t326','console','log').
load('t327','g_R_?','a').
load('t328','c_R_16','translateResponse').
actual('50','1','t328').
callRet('50','t328').
actual('51','1','t329').
callRet('51','t329').
load('t331','console','log').
actual('52','1','translationObj:').
callRet('52','translationObj:').
...
assign('t309','t337').
assign('e_R_16','a_R_0').
load('t339','c_R_16','translateResponse').
load('t340','c_R_16','translateResponse').
load('t341','t340','ld_result').
load('t343','c_R_16','translateResponse').
load('t344','t343','ld_result').
load('t345','t344','srclangs').
assign('e_R_16','t345').
assign('t338','t346').
assign('t347','t348').
assign('f_R_16','0').
load('t349','e_R_16','length').
assign('h_R_16','t349').
assign('t351','f_R_16').
assign('t350','t351').
load('t352','e_R_16','f_R_16').
load('t353','e_R_16','f_R_16').
load('t354','t353','toLowerCase_R_?').
store('e_R_16','f_R_16','t355').
assign('f_R_16','0').
load('t356','e_R_16','length').
assign('h_R_16','t356').
assign('t357','1').
assign('f_R_16','t357').
load('t359','g_R_?','e').
load('t361','console','log').
load('t362','d_R_16','srcLang').
load('t363','t362','toLowerCase').
actual('57','1','t365').
callRet('57','t365').
load('t367','console','log').
load('t368','c_R_16','tabLang').
load('t369','t368','toLowerCase').
actual('59','1','t371').
callRet('59','t371').
load('t373','console','log').
load('t374','g_R_?','options').
load('t375','t374','language').
load('t376','t375','toLowerCase').
actual('61','1','t378').
callRet('61','t378').
assign('t358','t380').
assign('t382','b_R_16').
load('t383','b_R_16','type').
assign('t381','t385').
load('t386','g_R_?','options').
load('t387','t386','language').
load('t388','t387','toLowerCase').
assign('h_R_16','t389').
load('t390','d_R_16','srcLang').
load('t391','t390','toLowerCase').
assign('i_R_?','t394').
load('t397','g_R_?','contains_R_?').
actual('64','1','e_R_16').
callRet('64','e_R_16').
actual('64','2','h_R_16').
callRet('64','h_R_16').
...
assign('t404','0').
assign('f_R_16','t404').
assign('(None, "e_R_16")','translation').
assign('e_R_16','definition').
assign('t406','b_R_16').
assign('t407','d_R_16').
assign('e_R_16','none').
assign('t405','t409').
load('t411','_gaq_R_0','push_R_?').
store('t412','0','_trackEvent').
store('t412','1','lookup').
store('t412','2','t413').
actual('65','1','t412').
callRet('65','t412').
assign('t410','t414').
load('t416','c_R_16','request').
load('t417','t416','type').
assign('t415','t418').
assign('e_R_16','a_R_0').
assign('t419','t420').
assign('t421','b_R_16').
assign('e_R_16','b_R_16').
load('t423','e_R_16','moreUrl').
load('t424','g_R_?','b').
load('t427','g_R_?','options').
load('t428','t427','language').
load('t431','g_R_?','options').
load('t432','t431','language').
load('t435','c_R_16','sanitizedQuery').
actual('66','1','t435').
callRet('66','t435').
assign('t423','t438').
assign('t422','t423').
assign('e_R_16','d_R_16').
load('t440','e_R_16','moreUrl').
load('t441','g_R_?','b').
load('t444','g_R_?','options').
load('t445','t444','language').
load('t448','c_R_16','sanitizedQuery').
actual('67','1','t448').
callRet('67','t448').
assign('t440','t450').
assign('t439','t440').
load('t452','e_R_16','prettyQuery').
assign('t453','t452').
load('t455','e_R_16','prettyQuery').
load('t456','c_R_16','sanitizedQuery').
assign('t455','t456').
assign('t451','t457').
assign('t458','1').
assign('b_R_16','t458').
assign('t460','LEAPFROG_MODE_R_?').
load('t461','g_R_?','options').
load('t462','t461','popupDblclick').
load('t463','g_R_?','options').
load('t464','t463','popupDblclickKey').
load('t467','g_R_?','options').
load('t468','t467','popupSelect').
load('t469','g_R_?','options').
load('t470','t469','popupSelectKey').
load('t475','g_R_?','contains').
load('t476','g_R_?','j').
load('t477','c_R_16','sanitizedQuery').
actual('68','1','t476').
callRet('68','t476').
actual('68','2','t477').
callRet('68','t477').
...
assign('t480','0').
assign('b_R_16','t480').
load('t481','c_R_16','request').
load('t482','t481','eventKey').
store('b_R_16','eventKey_R_?','t482').
load('t483','c_R_16','sanitizedQuery').
store('b_R_16','sanitizedQuery_R_?','t483').
store('b_R_16','meaningObj_R_?','e_R_16').
store('b_R_16','showOptionsTip_R_?','b_R_16').
assign('b_R_16','__objectInit__').
load('t485','g_R_?','e').
load('t486','console','log').
actual('69','1','finalResponse:').
callRet('69','finalResponse:').
load('t488','console','log').
load('t489','g_R_?','a').
actual('70','1','b_R_16').
callRet('70','b_R_16').
actual('71','1','t490').
...
assign('b_R_16','').
load('t494','g_R_?','n_R_?').
load('t495','c_R_16','translateResponse').
actual('72','1','t495').
callRet('72','t495').
load('t497','g_R_?','m_R_?').
load('t498','c_R_16','dictResponse').
actual('73','1','t498').
callRet('73','t498').
assign('None','t496').
assign('b_R_16','t499').
load('t501','c_R_16','request').
load('t502','t501','eventKey').
store('t500','eventKey_R_?','t502').
load('t503','c_R_16','sanitizedQuery').
store('t500','sanitizedQuery_R_?','t503').
store('t500','html_R_?','b_R_16').
assign('b_R_16','t500').
assign('t493','b_R_16').
load('t505','c_R_16','callback_R_?').
actual('74','1','b_R_16').
callRet('74','b_R_16').
assign('t504','t506').
assign('t508','b_R_17').
load('t509','b_R_17','sentences').
load('t510','t509','0').
load('t511','t510','orig').
load('t512','t511','toLowerCase_R_?').
load('t514','b_R_17','sentences').
load('t515','t514','0').
load('t516','t515','trans').
load('t517','t516','toLowerCase').
assign('t507','t520').
methodRet('d_lambda_R_17','a_R_0').
load('t521','window','gdx.LANG_MAP').
load('t522','b_R_17','src').
load('t523','t522','toLowerCase').
load('t525','t521','t524').
assign('c_R_17','t525').
load('t527','b_R_17','src').
assign('c_R_17','t527').
assign('t526','t528').
store('t529','type_R_?','translation').
store('t529','meaningText_R_?','t530').
store('t529','attribution_R_?','t531').
load('t532','b_R_17','src').
store('t529','srcLang_R_?','t532').
methodRet('d_lambda_R_17','t529').
...
load('t533','b_R_17','sentences').
load('t534','t533','0').
load('t535','t534','orig').
load('t536','t535','toLowerCase_R_?').
assign('c_R_18','t537').
load('t538','b_R_17','sentences').
load('t539','t538','0').
load('t540','t539','trans').
load('t541','t540','toLowerCase').
assign('f_R_?','t542').
assign('h_R_?','f_R_?').
load('t544','b_R_17','dict').
load('t546','b_R_17','dict').
load('t547','t546','length').
assign('t543','t549').
assign('t550','t551').
assign('i_R_18','0').
load('t552','b_R_17','dict').
load('t553','t552','length').
assign('l_R_?','t553').
assign('t555','i_R_18').
assign('t554','t555').
assign('t556','t559').
load('t560','b_R_17','dict').
load('t561','t560','i_R_18').
assign('j_R_18','t561').
assign('n_R_?','0').
assign('m_R_?','0').
load('t562','j_R_18','terms').
load('t563','t562','length').
assign('o_R_?','t563').
assign('t565','m_R_?').
assign('t564','t565').
load('t566','j_R_18','terms').
load('t567','t566','m_R_?').
load('t568','t567','toLowerCase').
assign('k_R_18','t569').
load('t571','k_R_18','length').
assign('h_R_?','t577').
assign('t578','n_R_?').
assign('t570','t579').
load('t580','b_R_17','dict').
load('t581','t580','i_R_18').
assign('j_R_18','t581').
assign('n_R_?','0').
assign('m_R_?','0').
load('t582','j_R_18','terms').
load('t583','t582','length').
assign('o_R_?','t583').
assign('i_R_18','0').
load('t584','b_R_17','dict').
load('t585','t584','length').
assign('l_R_?','t585').
methodRet('d_lambda_R_18','h_R_?').
load('t586','b_R_19','c_R_19').
assign('e_R_?','t586').
assign('c_R_19','0').
assign('e_R_?','__undefined__').
assign('t588','c_R_19').
...
assign('t589','t595').
load('t596','e_R_?','text').
methodRet('d_lambda_R_19','t596').
assign('c_R_19','0').
assign('e_R_?','__undefined__').
methodRet('d_lambda_R_19','').
assign('t598','b_R_20').
load('t599','b_R_20','length').
assign('t597','t601').
methodRet('d_lambda_R_20','a_R_0').
load('t602','b_R_20','d_R_20').
assign('c_R_?','t602').
assign('d_R_20','0').
assign('c_R_?','__undefined__').
assign('t604','d_R_20').
assign('t603','t604').
load('t605','c_R_?','entries').
load('t606','t605','e_R_20').
assign('f_R_?','t606').
assign('e_R_20','0').
assign('f_R_?','__undefined__').
assign('t608','e_R_20').
assign('t607','t608').
load('t610','f_R_?','type').
load('t612','f_R_?','terms').
load('t614','f_R_?','terms').
load('t615','t614','length').
assign('t609','t617').
load('t618','g_R_?','d_R_20').
load('t619','f_R_?','terms').
actual('82','1','t619').
callRet('82','t619').
actual('82','2','text').
callRet('82','text').
...
assign('t621','h_R_20').
load('t623','g_R_?','d').
load('t624','c_R_?','terms').
actual('83','1','t624').
callRet('83','t624').
actual('83','2','text').
callRet('83','text').
store('t622','prettyQuery_R_?','t625').
store('t622','meaningText_R_?','h_R_20').
load('t626','g_R_?','d').
load('t627','c_R_?','terms').
actual('84','1','t627').
callRet('84','t627').
actual('84','2','sound').
callRet('84','sound').
store('t622','audio_R_?','t628').
load('t629','g_R_?','d').
load('t630','f_R_?','terms').
actual('85','1','t630').
callRet('85','t630').
actual('85','2','url').
callRet('85','url').
store('t622','attribution_R_?','t631').
methodRet('d_lambda_R_20','t622').
assign('e_R_20','0').
assign('f_R_?','__undefined__').
assign('d_R_20','0').
assign('c_R_?','__undefined__').
methodRet('d_lambda_R_20','a_R_0').
assign('t633','b_R_21').
load('t634','b_R_21','error').
assign('t632','t635').
methodRet('d_lambda_R_21','a_R_0').
load('t636','g_R_?','i_R_?').
load('t637','b_R_21','primaries').
actual('86','1','t637').
callRet('86','t637').
assign('d_R_21','t638').
load('t640','d_R_21','attribution').
assign('t640','').
load('t641','d_R_21','type').
assign('t641','licensedDef').
load('t642','g_R_?','i').
load('t643','b_R_21','webDefinitions').
actual('87','1','t643').
callRet('87','t643').
assign('d_R_21','t644').
load('t645','d_R_21','type').
assign('t645','webDef').
assign('None','t641').
assign('t639','t646').
methodRet('d_lambda_R_21','d_R_21').
load('t647','g_R_?','h_R_22').
assign('t648','1').
actual('88','1','b_R_22').
callRet('88','b_R_22').
actual('88','2','t648').
...
assign('t651','d_R_22').
assign('t650','t651').
methodRet('d_lambda_R_22','').
load('t652','d_R_22','meaningText').
load('t655','d_R_22','attribution').
assign('d_R_22','t657').
assign('c_R_22','').
load('t659','b_R_22','dict').
load('t660','b_R_22','dict').
load('t661','t660','length').
assign('t658','t663').
assign('t664','t665').
assign('c_R_22','<h3 class="dct-tl">Translated definitions</h3>').
assign('e_R_?','0').
load('t666','b_R_22','dict').
load('t667','t666','length').
assign('f_R_?','t667').
assign('t669','e_R_?').
assign('t668','t669').
load('t670','b_R_22','dict').
load('t671','t670','e_R_?').
assign('h_R_22','t671').
load('t672','h_R_22','pos').
assign('c_R_22','t674').
assign('t675','t676').
assign('i_R_22','0').
load('t677','h_R_22','terms').
load('t678','t677','length').
assign('l_R_?','t678').
assign('t680','i_R_22').
assign('t679','t680').
load('t681','h_R_22','terms').
load('t682','t681','i_R_22').
assign('j_R_22','t682').
load('t684','j_R_22','length').
assign('c_R_22','t687').
assign('t683','t688').
assign('i_R_22','0').
load('t689','h_R_22','terms').
load('t690','t689','length').
assign('l_R_?','t690').
assign('c_R_22','</ol>').
assign('c_R_22','<h3 class="dct-tl">Translated definitions</h3>').
assign('e_R_?','0').
load('t691','b_R_22','dict').
load('t692','t691','length').
assign('f_R_?','t692').
methodRet('d_lambda_R_22','t694').
assign('t696','b_R_23').
load('t697','b_R_23','error').
assign('t695','t698').
methodRet('d_lambda_R_23','').
load('t699','google_R_?','language').
load('t700','t699','dictionary').
load('t701','t700','createResultHtml_R_?').
actual('89','1','b_R_23').
callRet('89','b_R_23').
methodRet('d_lambda_R_23','t702').
load('t704','dict_api_R_?','load_R_?').
load('t705','g_R_?','b').
actual('90','1','t706').
callRet('90','t706').
actual('90','2','1').
...
callRet('90','en').
assign('t703','t707').
load('t708','window','localStorage').
load('t709','t708','options').
assign('b_R_24','t709').
assign('t710','b_R_24').
load('t711','g_R_?','options').
load('t712','JSON_R_?','parse_R_?').
actual('91','1','b_R_24').
callRet('91','b_R_24').
store('g_R_?','options','t713').
load('t714','g_R_?','options').
load('t715','t714','language').
load('t716','g_R_?','options').
load('t717','t716','language').
store('t714','language','t718').
load('t719','g_R_?','options').
load('t720','t719','popupDblclick').
load('t721','g_R_?','options').
load('t722','t721','popupDblclick').
assign('t723','0').
store('t719','popupDblclick','t724').
load('t725','g_R_?','options').
load('t726','t725','popupDblclickKey').
load('t727','g_R_?','options').
load('t728','t727','popupDblclickKey').
store('t725','popupDblclickKey','t729').
load('t730','g_R_?','options').
load('t731','t730','popupSelect').
load('t732','g_R_?','options').
load('t733','t732','popupSelect').
assign('t734','1').
store('t730','popupSelect','t735').
load('t736','g_R_?','options').
load('t737','t736','popupSelectKey').
load('t738','g_R_?','options').
load('t739','t738','popupSelectKey').
store('t736','popupSelectKey','t740').
load('t742','g_R_?','options').
load('t743','t742','popupMode').
assign('t741','t743').
load('t745','g_R_?','options').
load('t746','t745','popupMode').
assign('t744','t747').
load('t749','g_R_?','options').
load('t750','t749','popupMode').
load('t752','g_R_?','options').
load('t753','t752','popupMode').
assign('t748','t755').
load('t757','g_R_?','options').
load('t758','t757','popupDblclickKey').
assign('t758','ctrl').
load('t759','g_R_?','options').
load('t760','t759','popupSelect').
assign('t761','0').
assign('t760','t761').
load('t762','g_R_?','options').
load('t763','t762','popupSelectKey').
assign('t763','ctrl').
assign('t756','t763').
load('t764','g_R_?','options').
load('t765','t764','popupDblclick').
assign('t766','1').
store('t764','popupDblclick','t766').
load('t767','g_R_?','options').
load('t768','t767','popupMode').
store('t767','popupMode','a_R_0').
load('t769','g_R_?','options').
load('t770','t769','enableHttps').
assign('t771','0').
store('t769','enableHttps','t771').
load('t772','window','localStorage').
load('t773','t772','options').
load('t774','JSON_R_?','stringify_R_?').
load('t775','g_R_?','options').
actual('92','1','t775').
callRet('92','t775').
store('t772','options','t776').
load('t778','chrome','extension').
load('t779','t778','onRequest').
load('t780','t779','addListener').
load('t781','g_R_?','r').
actual('93','1','t781').
callRet('93','t781').
assign('t777','t782').
load('t784','chrome','extension').
load('t785','t784','onRequest').
load('t786','t785','addListener').
load('t787','g_R_?','s').
actual('94','1','t787').
callRet('94','t787').
assign('t783','t788').
load('t790','chrome','extension').
load('t791','t790','onRequest').
load('t792','t791','addListener').
load('t793','g_R_?','q').
actual('95','1','t793').
callRet('95','t793').
assign('t789','t794').
load('t795','window','gdx.updateOptions').
load('t796','g_R_?','t').
store('window','gdx.updateOptions','t796').
load('t797','a_R_25','replace_R_?').
actual('96','1','{"regexp": "^\\s+|\\s+$", "modifiers": "g"}').
callRet('96','{"regexp": "^\\s+|\\s+$", "modifiers": "g"}').
actual('96','2','').
callRet('96','None').
methodRet('d_lambda_R_25','t798').
methodRet('d_lambda_R_26','lambda_R_27').
...
load('t799','b_R_26','apply_R_?').
actual('97','1','a_R_26').
callRet('97','a_R_26').
actual('97','2','arguments_R_?').
callRet('97','arguments_R_?').
methodRet('d_lambda_R_27','t800').
assign('a_R_28','__undefined__').
assign('b_R_0','__undefined__').
load('t802','self_R_?','pageYOffset').
assign('t801','t802').
load('t804','document','documentElement').
load('t805','document','documentElement').
load('t806','t805','scrollTop').
assign('t803','t807').
load('t809','document','body').
assign('t808','t809').
load('t811','document','body').
load('t812','t811','scrollLeft').
assign('a_R_28','t812').
load('t813','document','body').
load('t814','t813','scrollTop').
assign('b_R_0','t814').
assign('t810','b_R_0').
load('t816','document','documentElement').
load('t817','t816','scrollLeft').
assign('a_R_28','t817').
load('t818','document','documentElement').
load('t819','t818','scrollTop').
assign('b_R_0','t819').
assign('t815','b_R_0').
load('t821','self_R_?','pageXOffset').
assign('a_R_28','t821').
load('t822','self_R_?','pageYOffset').
assign('b_R_0','t822').
assign('t820','b_R_0').
store('t823','0','a_R_28').
store('t823','1','b_R_0').
methodRet('d_lambda_R_28','t823').
load('t825','a_R_29','tagName').
assign('t824','t826').
load('t827','a_R_29','tagName').
load('t828','t827','toLowerCase_R_?').
assign('b_R_29','t829').
assign('t830','t833').
assign('t834','0').
methodRet('d_lambda_R_29','t834').
load('t836','document','designMode').
load('t837','document','designMode').
load('t838','t837','toLowerCase').
assign('t835','t841').
assign('t842','0').
methodRet('d_lambda_R_29','t842').
assign('t843','a_R_29').
load('t844','a_R_29','parentNode').
assign('a_R_29','t844').
load('t846','a_R_29','isContentEditable').
assign('t845','t846').
assign('t847','0').
methodRet('d_lambda_R_29','t847').
assign('t848','1').
methodRet('d_lambda_R_29','t848').
load('t849','document','createElement_R_?').
actual('100','1','div').
callRet('100','div').
assign('a_R_30','t850').
load('t851','a_R_30','innerHTML').
store('a_R_30','innerHTML','<br>').
load('t852','a_R_30','firstChild').
load('t853','t852','nodeType').
methodRet('d_lambda_R_30','t854').
load('t856','chrome','extension').
load('t857','t856','sendRequest').
store('t858','type_R_?','initialize').
actual('101','1','this').
callRet('101','this').
actual('101','2','lambda_R_32').
callRet('101','lambda_R_32').
actual('102','1','t858').
callRet('102','t858').
actual('102','2','t859').
callRet('102','t859').
...
load('t861','this','D').
load('t862','a_R_32','instanceId').
store('this','D','t862').
load('t863','this','s').
load('t864','a_R_32','leapfrogServerUrl').
store('this','s','t864').
load('t865','document','createElement_R_?').
actual('103','1','div').
callRet('103','div').
assign('a_R_32','t866').
load('t867','document','createElement').
actual('104','1','a').
callRet('104','a').
assign('b_R_0','t868').
load('t869','b_R_0','target').
store('b_R_0','target','_blank').
load('t870','this','v').
load('t871','a_R_32','cloneNode_R_?').
assign('t872','1').
actual('105','1','t872').
callRet('105','t872').
store('this','v','t873').
load('t874','this','p').
load('t875','document','createElement').
actual('106','1','audio').
callRet('106','audio').
store('this','p','t876').
load('t877','this','p').
...
load('t884','this','d').
load('t885','t884','id').
store('t884','id','gdx-bubble-container').
load('t886','this','a').
load('t887','a_R_32','cloneNode').
assign('t888','1').
actual('108','1','t888').
callRet('108','t888').
store('this','a','t889').
load('t890','this','a').
load('t891','t890','id').
store('t890','id','gdx-bubble-main').
load('t893','this','d').
load('t894','t893','appendChild_R_?').
load('t895','this','a').
actual('109','1','t895').
callRet('109','t895').
assign('t892','t896').
load('t897','this','b').
load('t898','a_R_32','cloneNode').
assign('t899','1').
actual('110','1','t899').
callRet('110','t899').
store('this','b','t900').
load('t901','this','b').
load('t902','t901','id').
store('t901','id','gdx-bubble-query-container').
load('t903','this','t').
load('t904','a_R_32','cloneNode').
assign('t905','1').
actual('111','1','t905').
callRet('111','t905').
store('this','t','t906').
load('t907','this','t').
load('t908','t907','id').
store('t907','id','gdx-bubble-query').
load('t909','this','j').
load('t910','a_R_32','cloneNode').
assign('t911','1').
actual('112','1','t911').
callRet('112','t911').
store('this','j','t912').
load('t913','this','j').
load('t914','t913','id').
store('t913','id','gdx-bubble-audio-icon').
load('t915','this','j').
load('t916','t915','style').
load('t917','t916','backgroundImage').
actual('113','1','this').
callRet('113','this').
actual('113','2','audio.png').
callRet('113','audio.png').
store('t916','backgroundImage','t919').
load('t920','a_R_32','cloneNode').
assign('t921','1').
actual('114','1','t921').
callRet('114','t921').
assign('c_R_32','t922').
load('t923','c_R_32','id').
store('c_R_32','id','gdx-bubble-query-container-end').
load('t925','this','b').
load('t926','t925','appendChild').
load('t927','this','t').
actual('115','1','t927').
callRet('115','t927').
assign('t924','t928').
load('t930','this','b').
load('t931','t930','appendChild').
load('t932','this','j').
actual('116','1','t932').
callRet('116','t932').
assign('t929','t933').
load('t935','this','b').
load('t936','t935','appendChild').
actual('117','1','c_R_32').
callRet('117','c_R_32').
assign('t934','t937').
load('t938','this','h').
load('t939','a_R_32','cloneNode').
assign('t940','1').
actual('118','1','t940').
callRet('118','t940').
store('this','h','t941').
load('t942','this','h').
load('t943','t942','id').
store('t942','id','gdx-bubble-meaning').
load('t944','this','f').
load('t945','a_R_32','cloneNode').
assign('t946','1').
actual('119','1','t946').
callRet('119','t946').
store('this','f','t947').
load('t948','this','f').
load('t949','t948','id').
store('t948','id','gdx-bubble-options-tip').
load('t950','this','f').
load('t951','t950','innerHTML').
store('t950','innerHTML','x_R_?').
load('t952','this','i').
load('t953','a_R_32','cloneNode').
assign('t954','1').
actual('120','1','t954').
callRet('120','t954').
store('this','i','t955').
load('t956','this','i').
load('t957','t956','id').
store('t956','id','gdx-bubble-more').
load('t958','this','g').
load('t959','b_R_0','cloneNode').
assign('t960','1').
actual('121','1','t960').
callRet('121','t960').
store('this','g','t961').
load('t963','this','i').
load('t964','t963','appendChild').
load('t965','this','g').
actual('122','1','t965').
callRet('122','t965').
assign('t962','t966').
load('t967','this','e').
load('t968','a_R_32','cloneNode').
assign('t969','1').
actual('123','1','t969').
callRet('123','t969').
store('this','e','t970').
load('t971','this','e').
load('t972','t971','id').
store('t971','id','gdx-bubble-attribution').
load('t973','this','l').
load('t974','b_R_0','cloneNode').
assign('t975','1').
actual('124','1','t975').
callRet('124','t975').
store('this','l','t976').
load('t977','this','o').
load('t978','a_R_32','cloneNode').
assign('t979','1').
actual('125','1','t979').
callRet('125','t979').
store('this','o','t980').
load('t982','this','e').
load('t983','t982','appendChild').
load('t984','this','l').
actual('126','1','t984').
callRet('126','t984').
assign('t981','t985').
load('t987','this','e').
load('t988','t987','appendChild').
load('t989','this','o').
actual('127','1','t989').
callRet('127','t989').
assign('t986','t990').
load('t991','this','q').
load('t992','a_R_32','cloneNode').
assign('t993','1').
actual('128','1','t993').
callRet('128','t993').
store('this','q','t994').
load('t995','this','q').
load('t996','t995','id').
store('t995','id','gdx-bubble-close').
load('t997','this','q').
load('t998','t997','style').
load('t999','t998','backgroundImage').
actual('129','1','this').
callRet('129','this').
actual('129','2','close.png').
callRet('129','close.png').
store('t998','backgroundImage','t1001').
load('t1003','this','s').
assign('t1002','t1003').
load('t1005','this','a').
load('t1006','t1005','style').
load('t1007','t1006','paddingLeft').
assign('t1007','"""""""""""27px !important"""""""""""').
load('t1008','this','r').
load('t1009','b_R_0','cloneNode').
assign('t1010','1').
actual('130','1','t1010').
callRet('130','t1010').
assign('t1008','t1011').
load('t1012','this','r').
load('t1013','t1012','id').
assign('t1013','gdx-bubble-help').
load('t1014','this','r').
load('t1015','t1014','style').
load('t1016','t1015','backgroundImage').
actual('131','1','this').
callRet('131','this').
actual('131','2','question_mark.png').
callRet('131','question_mark.png').
assign('t1016','t1018').
load('t1019','this','r').
load('t1020','t1019','href').
assign('t1020','http://www.google.com/support/toolbar/bin/answer.py?answer=191164').
load('t1021','this','u').
load('t1022','a_R_32','cloneNode').
assign('t1023','1').
actual('132','1','t1023').
callRet('132','t1023').
assign('t1021','t1024').
load('t1025','this','u').
load('t1026','t1025','id').
assign('t1026','gdx-bubble-favicon').
load('t1027','this','u').
load('t1028','t1027','style').
load('t1029','t1028','backgroundImage').
actual('133','1','this').
callRet('133','this').
actual('133','2','google_favicon.png').
callRet('133','google_favicon.png').
assign('t1029','t1031').
assign('t1004','t1029').
load('t1033','this','s').
load('t1034','this','a').
load('t1035','t1034','appendChild').
load('t1036','this','u').
actual('134','1','t1036').
callRet('134','t1036').
assign('t1032','t1038').
load('t1040','this','a').
load('t1041','t1040','appendChild').
load('t1042','this','q').
actual('135','1','t1042').
callRet('135','t1042').
assign('t1039','t1043').
load('t1045','this','s').
load('t1046','this','a').
load('t1047','t1046','appendChild').
load('t1048','this','r').
actual('136','1','t1048').
callRet('136','t1048').
assign('t1044','t1050').
load('t1052','this','a').
load('t1053','t1052','appendChild').
load('t1054','this','b').
actual('137','1','t1054').
callRet('137','t1054').
assign('t1051','t1055').
load('t1057','this','a').
load('t1058','t1057','appendChild').
load('t1059','this','h').
actual('138','1','t1059').
callRet('138','t1059').
assign('t1056','t1060').
load('t1062','this','a').
load('t1063','t1062','appendChild').
load('t1064','this','f').
actual('139','1','t1064').
callRet('139','t1064').
assign('t1061','t1065').
load('t1067','this','a').
load('t1068','t1067','appendChild').
load('t1069','this','e').
actual('140','1','t1069').
callRet('140','t1069').
assign('t1066','t1070').
load('t1072','this','a').
load('t1073','t1072','appendChild').
load('t1074','this','i').
actual('141','1','t1074').
callRet('141','t1074').
assign('t1071','t1075').
load('t1076','this','n').
load('t1077','a_R_32','cloneNode').
assign('t1078','1').
actual('142','1','t1078').
callRet('142','t1078').
store('this','n','t1079').
load('t1080','this','n').
load('t1081','t1080','id').
store('t1080','id','gdx-arrow-container').
load('t1083','this','d').
load('t1084','t1083','appendChild').
load('t1085','this','n').
actual('143','1','t1085').
callRet('143','t1085').
assign('t1082','t1086').
...
store('this','z','t1105').
load('t1107','this','w').
actual('151','1','dblclick').
callRet('151','dblclick').
actual('151','2','t1107').
callRet('151','t1107').
actual('151','3','document').
callRet('151','document').
assign('t1106','t1108').
load('t1110','this','C').
actual('152','1','mouseup').
callRet('152','mouseup').
actual('152','2','t1110').
callRet('152','t1110').
actual('152','3','document').
callRet('152','document').
assign('t1109','t1111').
load('t1113','this','A').
actual('153','1','resize').
callRet('153','resize').
...
assign('t1112','t1114').
load('t1116','this','B').
actual('154','1','keydown').
callRet('154','keydown').
actual('154','2','t1116').
callRet('154','t1116').
actual('154','3','document').
callRet('154','document').
assign('t1115','t1117').
load('t1119','this','p').
load('t1120','this','p').
load('t1121','t1120','play').
actual('155','1','t1119').
callRet('155','t1119').
actual('155','2','t1121').
callRet('155','t1121').
...
callRet('156','t1123').
assign('t1118','t1124').
load('t1126','chrome','extension').
load('t1127','t1126','onRequest').
load('t1128','t1127','addListener').
actual('157','1','A_R_0').
callRet('157','A_R_0').
assign('t1125','t1129').
load('t1131','chrome','extension').
load('t1132','t1131','onRequest').
load('t1133','t1132','addListener').
load('t1134','this','z').
actual('158','1','t1134').
callRet('158','t1134').
assign('t1130','t1135').
load('t1137','document','addEventListener').
load('t1138','c_R_33','addEventListener_R_?').
assign('t1139','1').
actual('159','1','a_R_33').
callRet('159','a_R_33').
actual('159','2','b_R_33').
...
actual('159','3','t1139').
callRet('159','t1139').
load('t1141','c_R_33','attachEvent_R_?').
actual('160','1','t1142').
callRet('160','t1142').
actual('160','2','b_R_33').
callRet('160','b_R_33').
assign('None','t1140').
assign('t1136','t1143').
load('t1145','document','removeEventListener').
load('t1146','c_R_34','removeEventListener_R_?').
assign('t1147','1').
actual('161','1','a_R_34').
callRet('161','a_R_34').
actual('161','2','b_R_34').
...
actual('161','3','t1147').
callRet('161','t1147').
load('t1149','c_R_34','detachEvent_R_?').
actual('162','1','t1150').
callRet('162','t1150').
actual('162','2','b_R_34').
callRet('162','b_R_34').
...
assign('t1144','t1151').
load('t1153','a_R_35','w').
actual('163','1','dblclick').
callRet('163','dblclick').
actual('163','2','t1153').
callRet('163','t1153').
actual('163','3','document').
callRet('163','document').
assign('t1152','t1154').
load('t1156','a_R_35','C').
actual('164','1','mouseup').
callRet('164','mouseup').
actual('164','2','t1156').
callRet('164','t1156').
actual('164','3','document').
callRet('164','document').
assign('t1155','t1157').
load('t1159','a_R_35','A').
actual('165','1','resize').
callRet('165','resize').
...
assign('t1158','t1160').
load('t1162','a_R_35','B').
actual('166','1','keydown').
callRet('166','keydown').
actual('166','2','t1162').
callRet('166','t1162').
actual('166','3','document').
callRet('166','document').
assign('t1161','t1163').
load('t1165','chrome','extension').
load('t1166','t1165','onRequest').
load('t1167','t1166','removeListener').
actual('167','1','A_R_0').
callRet('167','A_R_0').
assign('t1164','t1168').
load('t1170','chrome','extension').
load('t1171','t1170','onRequest').
load('t1172','t1171','removeListener').
load('t1173','a_R_35','z').
actual('168','1','t1173').
callRet('168','t1173').
assign('t1169','t1174').
load('t1176','a_R_35','k_R_?').
assign('t1175','t1177').
load('t1179','a_R_36','s').
assign('t1178','t1179').
load('t1180','a_R_36','s').
methodRet('d_lambda_R_36','t1184').
load('t1185','chrome','extension').
load('t1186','t1185','getURL').
actual('170','1','t1187').
callRet('170','t1187').
methodRet('d_lambda_R_36','t1190').
load('t1191','a_R_37','cloneNode_R_?').
assign('t1192','1').
actual('171','1','t1192').
callRet('171','t1192').
assign('c_R_37','t1193').
load('t1194','a_R_37','cloneNode').
assign('t1195','1').
actual('172','1','t1195').
callRet('172','t1195').
assign('g_R_?','t1196').
load('t1197','a_R_37','cloneNode').
assign('t1198','1').
actual('173','1','t1198').
callRet('173','t1198').
assign('e_R_?','t1199').
load('t1200','c_R_37','className').
store('c_R_37','className','gdx-arrow-main').
load('t1201','g_R_?','className').
store('g_R_?','className','gdx-bubble-arrow-inner').
load('t1202','e_R_?','className').
store('e_R_?','className','gdx-bubble-arrow-outer').
load('t1205','g_R_?','id').
assign('t1205','gdx-bubble-arrow-inner-up').
load('t1206','e_R_?','id').
assign('t1206','gdx-bubble-arrow-outer-up').
load('t1207','g_R_?','id').
assign('t1207','gdx-bubble-arrow-inner-down').
load('t1208','e_R_?','id').
assign('t1208','gdx-bubble-arrow-outer-down').
assign('None','t1206').
assign('t1203','t1208').
load('t1210','c_R_37','appendChild_R_?').
actual('174','1','g_R_?').
callRet('174','g_R_?').
assign('t1209','t1211').
load('t1213','c_R_37','appendChild').
actual('175','1','e_R_?').
callRet('175','e_R_?').
assign('t1212','t1214').
methodRet('d_lambda_R_37','c_R_37').
load('t1215','this','left').
store('this','left','a_R_38').
load('t1216','this','top').
store('this','top','b_R_38').
load('t1217','this','right').
store('this','right','c_R_38').
load('t1218','this','bottom').
store('this','bottom','g_R_38').
load('t1219','a_R_39','a').
load('t1220','t1219','style').
load('t1221','t1220','left').
store('t1220','left','0').
load('t1222','a_R_39','a').
load('t1223','t1222','style').
load('t1224','t1223','top').
store('t1223','top','0').
load('t1225','a_R_39','a').
load('t1226','t1225','offsetWidth').
assign('b_R_39','t1226').
load('t1227','a_R_39','a').
load('t1228','t1227','offsetHeight').
assign('c_R_39','t1228').
assign('g_R_?','t1229').
load('t1230','a_R_39','c').
load('t1231','t1230','left').
load('t1232','g_R_?','0').
store('e_R_?','0','t1233').
load('t1234','a_R_39','c').
load('t1235','t1234','top').
load('t1236','g_R_?','1').
store('e_R_?','1','t1237').
assign('e_R_?','e_R_?').
load('t1238','a_R_39','c').
load('t1239','t1238','bottom').
load('t1240','a_R_39','c').
load('t1241','t1240','top').
assign('h_R_?','t1242').
load('t1243','e_R_?','0').
load('t1244','a_R_39','c').
load('t1245','t1244','right').
load('t1246','a_R_39','c').
load('t1247','t1246','left').
assign('n_R_?','t1250').
load('t1251','document','documentElement').
load('t1252','t1251','offsetWidth').
load('t1253','document','body').
load('t1254','t1253','scrollLeft').
assign('g_R_?','t1255').
load('t1256','document','body').
load('t1257','t1256','scrollLeft').
assign('w_R_?','t1257').
assign('l_R_?','t1259').
assign('l_R_?','t1263').
assign('t1260','t1264').
...
load('t1272','e_R_?','1').
assign('m_R_?','t1275').
ptsTo('t1279','n_G_R_?_2').
prototype('n_G_R_?_2', 'p_G_R_?').
actual('177','1','l_R_?').
callRet('177','l_R_?').
actual('177','2','s_R_39').
callRet('177','s_R_39').
...
callRet('177','t1278').
assign('b_R_39','t1279').
load('t1280','b_R_39','top').
load('t1281','document','body').
load('t1282','t1281','scrollTop').
assign('t1276','t1283').
assign('t1284','t1285').
load('t1286','document','getElementsByTagName_R_?').
actual('177','1','embed').
callRet('177','embed').
assign('c_R_39','t1287').
load('t1288','document','getElementsByTagName').
actual('178','1','object').
callRet('178','object').
assign('E_R_?','t1289').
assign('t_R_?','t1290').
assign('p_R_?','0').
load('t1291','c_R_39','length').
load('t1292','E_R_?','length').
assign('L_R_?','t1293').
assign('t1295','p_R_?').
assign('t1294','t1295').
load('t1296','c_R_39','length').
load('t1298','c_R_39','p_R_?').
load('t1299','c_R_39','length').
load('t1301','E_R_?','t1300').
assign('(None, "j_R_39")','t1298').
load('t1302','t1301','getBoundingClientRect_R_?').
assign('j_R_39','t1303').
load('t1304','j_R_39','left').
load('t1305','t_R_?','0').
load('t1307','j_R_39','top').
load('t1308','t_R_?','1').
load('t1310','j_R_39','right').
load('t1311','t_R_?','0').
load('t1313','j_R_39','bottom').
load('t1314','t_R_?','1').
ptsTo('t1316','n_G_R_?_3').
prototype('n_G_R_?_3', 'p_G_R_?').
actual('181','1','t1306').
callRet('181','t1306').
actual('181','2','t1309').
callRet('181','t1309').
...
callRet('181','t1315').
assign('j_R_39','t1316').
load('t1318','b_R_39','bottom').
load('t1319','j_R_39','top').
load('t1321','j_R_39','bottom').
load('t1322','b_R_39','top').
load('t1325','b_R_39','left').
load('t1326','j_R_39','right').
load('t1329','j_R_39','left').
load('t1330','b_R_39','right').
assign('t1317','t1332').
assign('t1333','1').
assign('b_R_39','t1333').
load('t1334','document','getElementsByTagName_R_?').
actual('181','1','embed').
callRet('181','embed').
assign('c_R_39','t1335').
load('t1336','document','getElementsByTagName').
actual('182','1','object').
callRet('182','object').
assign('E_R_?','t1337').
assign('t_R_?','t1338').
assign('p_R_?','0').
load('t1339','c_R_39','length').
load('t1340','E_R_?','length').
assign('L_R_?','t1341').
assign('t1342','0').
assign('b_R_39','t1342').
assign('t1343','1').
...
load('t1345','a_R_39','F').
assign('m_R_?','t1345').
load('t1346','m_R_?','style').
load('t1347','t1346','top').
load('t1348','e_R_?','1').
assign('t1347','t1350').
assign('s_R_39','m_R_?').
load('t1351','a_R_39','G').
assign('m_R_?','t1351').
assign('b_R_39','0').
load('t1352','navigator_R_?','appName').
load('t1354','document','documentMode').
load('t1355','document','documentMode').
assign('t1358','t1357').
assign('b_R_39','16').
load('t1361','m_R_?','style').
load('t1362','t1361','top').
load('t1363','e_R_?','1').
assign('t1362','t1366').
assign('None','t1347').
assign('t1344','t1362').
assign('e_R_?','t1367').
load('t1368','m_R_?','style').
load('t1369','t1368','left').
store('t1368','left','t1370').
load('t1378','a_R_39','n').
load('t1379','t1378','appendChild_R_?').
actual('184','1','m_R_?').
callRet('184','m_R_?').
assign('t1371','t1381').
load('t1382','a_R_39','a').
load('t1383','t1382','style').
load('t1384','t1383','top').
store('t1383','top','t1385').
load('t1386','a_R_39','a').
load('t1387','t1386','style').
load('t1388','t1387','left').
store('t1387','left','t1389').
load('t1391','a_R_40','eventKey').
load('t1392','this','m').
assign('t1390','t1393').
load('t1395','this','k_R_?').
assign('t1394','t1396').
load('t1397','this','j').
load('t1398','t1397','style').
load('t1399','t1398','display').
store('t1398','display','none !important').
load('t1400','this','f').
load('t1401','t1400','style').
load('t1402','t1401','display').
store('t1401','display','none !important').
load('t1403','this','i').
load('t1404','t1403','style').
load('t1405','t1404','display').
store('t1404','display','block !important').
load('t1406','this','e').
load('t1407','t1406','style').
load('t1408','t1407','display').
store('t1407','display','none !important').
load('t1410','a_R_40','meaningObj').
assign('t1409','t1410').
load('t1412','this','b').
load('t1413','t1412','style').
load('t1414','t1413','display').
assign('t1414','none !important').
load('t1415','this','h').
load('t1416','t1415','innerHTML').
assign('t1416','No definition found.').
load('t1417','this','g').
load('t1418','t1417','href').
load('t1419','a_R_40','sanitizedQuery').
actual('186','1','t1419').
callRet('186','t1419').
assign('t1418','t1421').
load('t1422','this','g').
load('t1423','t1422','innerHTML').
load('t1424','a_R_40','sanitizedQuery').
assign('t1423','t1426').
assign('t1411','t1423').
load('t1427','a_R_40','meaningObj').
assign('b_R_40','t1427').
load('t1428','this','b').
load('t1429','t1428','style').
load('t1430','t1429','display').
store('t1429','display','block !important').
load('t1431','this','t').
load('t1432','t1431','innerHTML').
load('t1433','b_R_40','prettyQuery').
store('t1431','innerHTML','t1433').
load('t1434','this','h').
load('t1435','t1434','innerHTML').
load('t1436','b_R_40','meaningText').
store('t1434','innerHTML','t1436').
load('t1438','b_R_40','audio').
assign('t1437','t1438').
load('t1440','this','p').
load('t1441','t1440','src').
load('t1442','b_R_40','audio').
assign('t1441','t1442').
load('t1443','this','j').
load('t1444','t1443','style').
load('t1445','t1444','display').
assign('t1445','block !important').
assign('t1439','t1445').
load('t1446','this','g').
load('t1447','t1446','href').
load('t1448','b_R_40','moreUrl').
store('t1446','href','t1448').
load('t1449','this','g').
load('t1450','t1449','innerHTML').
store('t1449','innerHTML','More &raquo;').
load('t1452','b_R_40','attribution').
assign('t1451','t1452').
load('t1454','b_R_40','type').
load('t1456','this','o').
load('t1457','t1456','innerHTML').
load('t1458','b_R_40','attribution').
assign('t1457','t1458').
load('t1459','this','l').
load('t1460','t1459','style').
load('t1461','t1460','display').
assign('t1461','none !important').
load('t1462','this','o').
load('t1463','t1462','style').
load('t1464','t1463','display').
assign('t1464','inline !important').
load('t1465','this','v').
load('t1466','t1465','innerHTML').
load('t1467','b_R_40','attribution').
assign('t1466','t1467').
load('t1468','this','v').
load('t1469','t1468','getElementsByTagName_R_?').
actual('187','1','a').
callRet('187','a').
load('t1471','t1470','0').
assign('b_R_40','t1471').
load('t1472','this','l').
load('t1473','t1472','href').
load('t1474','b_R_40','href').
assign('t1473','t1474').
load('t1475','this','l').
load('t1476','t1475','innerHTML').
load('t1477','b_R_40','innerHTML').
load('t1478','t1477','replace_R_?').
actual('188','1','http://').
callRet('188','http://').
actual('188','2','').
callRet('188','None').
assign('t1476','t1479').
load('t1480','this','l').
load('t1481','t1480','style').
load('t1482','t1481','display').
assign('t1482','inline !important').
load('t1483','this','o').
load('t1484','t1483','style').
load('t1485','t1484','display').
assign('t1485','none !important').
assign('None','t1464').
load('t1486','this','e').
load('t1487','t1486','style').
load('t1488','t1487','display').
assign('t1488','block !important').
assign('t1453','t1488').
load('t1490','a_R_40','showOptionsTip').
assign('t1489','t1490').
load('t1491','this','f').
load('t1492','t1491','style').
load('t1493','t1492','display').
store('t1492','display','block !important').
load('t1495','document','body').
load('t1496','t1495','appendChild_R_?').
load('t1497','this','d').
actual('189','1','t1497').
callRet('189','t1497').
assign('t1494','t1498').
...
assign('t1501','t1503').
load('t1505','a_R_41','h').
load('t1506','t1505','innerHTML').
assign('t1506','Dictionary is disabled for https pages.').
load('t1507','a_R_41','g').
load('t1508','t1507','href').
assign('t1508','http://www.google.com/support/toolbar/bin/answer.py?answer=191164').
load('t1509','a_R_41','g').
load('t1510','t1509','innerHTML').
assign('t1510','More information &raquo;').
load('t1511','a_R_41','i').
load('t1512','t1511','style').
load('t1513','t1512','display').
assign('t1513','block !important').
load('t1514','a_R_41','b').
load('t1515','t1514','style').
load('t1516','t1515','display').
assign('t1516','none !important').
load('t1517','a_R_41','f').
load('t1518','t1517','style').
load('t1519','t1518','display').
assign('t1519','none !important').
load('t1520','a_R_41','e').
load('t1521','t1520','style').
load('t1522','t1521','display').
assign('t1522','none !important').
load('t1523','document','body').
load('t1524','t1523','appendChild_R_?').
load('t1525','a_R_41','d').
actual('191','1','t1525').
callRet('191','t1525').
actual('192','1','a_R_41').
callRet('192','a_R_41').
assign('t1504','t1527').
load('t1528','b_R_42','getBoundingClientRect_R_?').
assign('c_R_42','t1529').
load('t1530','a_R_42','c').
load('t1531','c_R_42','left').
load('t1532','c_R_42','top').
load('t1533','c_R_42','right').
load('t1534','c_R_42','bottom').
ptsTo('t1535','n_G_R_?_4').
prototype('n_G_R_?_4', 'p_G_R_?').
actual('194','1','t1531').
callRet('194','t1531').
actual('194','2','t1532').
callRet('194','t1532').
...
actual('194','4','t1534').
callRet('194','t1534').
store('a_R_42','c','t1535').
load('t1537','window','screen').
load('t1538','t1537','deviceXDPI').
load('t1539','window','screen').
load('t1540','t1539','logicalXDPI').
load('t1542','window','screen').
load('t1543','t1542','deviceXDPI').
load('t1544','window','screen').
load('t1545','t1544','logicalXDPI').
assign('c_R_42','t1546').
assign('t1536','t1548').
load('t1549','a_R_42','c').
load('t1550','t1549','g_R_42').
load('t1551','Math_R_?','round_R_?').
load('t1552','a_R_42','c').
load('t1553','t1552','g_R_42').
actual('194','1','t1554').
callRet('194','t1554').
store('t1549','g_R_42','t1555').
assign('g_R_42','__undefined__').
load('t1557','this','m').
assign('t1558','t1557').
assign('t1556','t1558').
load('t1559','this','d').
assign('a_R_43','t1559').
load('t1561','a_R_43','parentNode').
load('t1563','a_R_43','parentNode').
load('t1564','t1563','removeChild_R_?').
actual('195','1','a_R_43').
callRet('195','a_R_43').
assign('t1560','t1566').
load('t1568','a_R_43','hasChildNodes_R_?').
assign('t1567','t1570').
load('t1571','this','n').
assign('a_R_43','t1571').
load('t1573','a_R_43','removeChild').
load('t1574','a_R_43','childNodes').
load('t1575','t1574','0').
actual('197','1','t1575').
callRet('197','t1575').
assign('t1572','t1576').
load('t1578','a_R_44','keyCode').
load('t1580','this','k_R_?').
assign('t1577','t1582').
load('t1585','a_R_45','altKey').
load('t1589','window','navigator').
load('t1590','t1589','platform').
load('t1591','t1590','toLowerCase_R_?').
load('t1593','t1592','indexOf_R_?').
actual('200','1','mac').
callRet('200','mac').
assign('t1595','1').
load('t1597','a_R_45','metaKey').
load('t1598','a_R_45','ctrlKey').
assign('None','t1597').
load('t1602','a_R_45','shiftKey').
methodRet('d_lambda_R_45','t1604').
assign('t1605','c_R_46').
load('t1606','b_R_46','target').
load('t1607','b_R_46','srcElement').
assign('c_R_46','t1608').
load('t1609','c_R_46','parentNode').
assign('c_R_46','t1609').
load('t1611','a_R_46','d').
assign('t1610','t1612').
assign('t1613','0').
methodRet('d_lambda_R_46','t1613').
load('t1614','b_R_46','target').
load('t1615','b_R_46','srcElement').
assign('c_R_46','t1616').
assign('t1617','1').
methodRet('d_lambda_R_46','t1617').
assign('e_R_47','__undefined__').
load('t1620','g_R_47','popupSelect').
load('t1621','g_R_47','popupSelectKey').
actual('201','1','b_R_47').
callRet('201','b_R_47').
actual('201','2','t1621').
callRet('201','t1621').
assign('t1624','0').
assign('t1625','1').
load('t1627','g_R_47','popupSelect').
load('t1628','g_R_47','popupSelectKey').
actual('202','1','b_R_47').
callRet('202','b_R_47').
actual('202','2','t1628').
callRet('202','t1628').
assign('t1631','1').
load('t1632','g_R_47','popupDblclick').
load('t1633','g_R_47','popupDblclickKey').
actual('203','1','b_R_47').
callRet('203','b_R_47').
actual('203','2','t1633').
callRet('203','t1633').
...
assign('e_R_47','0').
assign('t1643','t1644').
load('t1645','C_R_?','length').
assign('h_R_47','t1645').
assign('t1647','e_R_47').
assign('t1646','t1647').
load('t1649','location_R_?','href').
load('t1650','t1649','match_R_?').
load('t1651','C_R_?','e_R_47').
actual('205','1','t1651').
callRet('205','t1651').
assign('t1648','t1652').
methodRet('d_lambda_R_47','null').
load('t1653','C_R_?','length').
assign('h_R_47','t1653').
load('t1655','b_R_47','target').
load('t1656','b_R_47','srcElement').
actual('206','1','t1657').
callRet('206','t1657').
assign('t1659','t1658').
assign('t1654','t1661').
assign('e_R_47','d_R_0').
assign('h_R_47','').
load('t1663','window','getSelection').
load('t1664','window','getSelection_R_?').
assign('h_R_47','t1665').
load('t1666','h_R_47','getRangeAt_R_?').
actual('209','1','0').
callRet('209','0').
assign('e_R_47','t1667').
load('t1668','h_R_47','toString_R_?').
actual('211','1','t1669').
callRet('211','t1669').
assign('h_R_47','t1670').
load('t1671','document','selection').
load('t1672','document','selection').
load('t1673','t1672','createRange_R_?').
assign('e_R_47','t1674').
load('t1675','e_R_47','text').
actual('213','1','t1675').
callRet('213','t1675').
assign('h_R_47','t1676').
assign('None','h_R_47').
load('t1678','h_R_47','length').
load('t1680','h_R_47','charCodeAt_R_?').
actual('214','1','0').
callRet('214','0').
load('t1684','h_R_47','match').
actual('215','1','u_R_?').
callRet('215','u_R_?').
assign('t1686','t1685').
assign('t1688','t1687').
load('t1691','h_R_47','indexOf_R_?').
actual('216','1',' ').
callRet('216',' ').
assign('t1693','1').
assign('t1696','t1695').
...
callRet('218','e_R_47').
assign('t1702','t1705').
load('t1707','g_R_47','enableHttps').
assign('t1708','t1707').
load('t1709','location_R_?','href').
load('t1710','t1709','substr_R_?').
actual('219','1','0').
callRet('219','0').
actual('219','2','5').
callRet('219','5').
...
actual('220','2','n_R_47').
callRet('220','n_R_47').
load('t1715','window','setTimeout_R_?').
actual('221','1','a_R_47').
callRet('221','a_R_47').
actual('221','2','lambda_R_48').
callRet('221','lambda_R_48').
actual('222','1','t1716').
callRet('222','t1716').
actual('222','2','300').
callRet('222','300').
load('t1718','chrome','extension').
load('t1719','t1718','sendRequest').
store('t1720','type_R_?','fetch_raw').
store('t1720','eventKey_R_?','n_R_47').
load('t1721','a_R_47','D').
store('t1720','instanceId_R_?','t1721').
store('t1720','query_R_?','h_R_47').
load('t1722','a_R_47','L').
actual('223','1','a_R_47').
callRet('223','a_R_47').
actual('223','2','t1722').
...
assign('t1725','t1727').
load('t1729','this','h').
load('t1730','t1729','innerHTML').
assign('t1730','Searching&hellip;').
load('t1731','this','b').
load('t1732','t1731','style').
load('t1733','t1732','display').
assign('t1733','none !important').
load('t1734','this','f').
load('t1735','t1734','style').
load('t1736','t1735','display').
assign('t1736','none !important').
load('t1737','this','i').
load('t1738','t1737','style').
load('t1739','t1738','display').
assign('t1739','none !important').
load('t1740','this','e').
load('t1741','t1740','style').
load('t1742','t1741','display').
assign('t1742','none !important').
load('t1743','document','body').
load('t1744','t1743','appendChild_R_?').
load('t1745','this','d').
actual('225','1','t1745').
callRet('225','t1745').
actual('226','1','this').
callRet('226','this').
assign('t1728','t1747').
load('t1748','a_R_49','target').
load('t1749','a_R_49','srcElement').
assign('b_R_49','t1750').
actual('227','1','this').
callRet('227','this').
actual('227','2','a_R_49').
...
assign('t1753','t1752').
load('t1754','this','q').
load('t1757','b_R_49','tagName').
load('t1758','t1757','toLowerCase_R_?').
load('t1762','this','k_R_?').
assign('t1751','t1764').
load('t1766','chrome','extension').
load('t1767','t1766','sendRequest').
store('t1768','type_R_?','options').
actual('230','1','this').
callRet('230','this').
actual('230','2','lambda_R_50').
callRet('230','lambda_R_50').
actual('231','1','t1768').
callRet('231','t1768').
actual('231','2','t1769').
callRet('231','t1769').
...
formal('d_lambda_R_50','1','b_R_50').
load('t1772','b_R_50','options').
actual('232','1','this').
callRet('232','this').
actual('232','2','a_R_49').
callRet('232','a_R_49').
actual('232','3','mouseup').
callRet('232','mouseup').
actual('232','4','t1772').
callRet('232','t1772').
assign('t1771','t1773').
load('t1775','chrome','extension').
load('t1776','t1775','sendRequest').
store('t1777','type_R_?','options').
actual('233','1','this').
callRet('233','this').
actual('233','2','lambda_R_52').
callRet('233','lambda_R_52').
actual('234','1','t1777').
callRet('234','t1777').
actual('234','2','t1778').
callRet('234','t1778').
...
formal('d_lambda_R_52','1','b_R_52').
load('t1781','b_R_52','options').
actual('235','1','this').
callRet('235','this').
actual('235','2','a_R_51').
callRet('235','a_R_51').
actual('235','3','dblclick').
callRet('235','dblclick').
actual('235','4','t1781').
callRet('235','t1781').
assign('t1780','t1782').
load('t1784','a_R_53','type').
load('t1786','window','getSelection_R_?').
load('t1788','t1787','toString_R_?').
actual('238','1','t1789').
callRet('238','t1789').
assign('a_R_53','t1790').
store('t1792','selection_R_?','a_R_53').
actual('239','1','t1792').
callRet('239','t1792').
assign('t1783','t1794').
load('t1796','a_R_54','type').
load('t1798','a_R_54','instanceId').
load('t1799','this','D').
load('t1802','this','k_R_?').
assign('t1795','t1804').
load('t1805','document','createElement_R_?').
actual('241','1','script').
callRet('241','script').
assign('ga_R_55','t1806').
load('t1807','ga_R_55','type').
store('ga_R_55','type','text/javascript').
load('t1808','ga_R_55','async').
store('ga_R_55','async','true').
load('t1809','ga_R_55','src').
store('ga_R_55','src','https://ssl.google-analytics.com/ga.js').
load('t1810','document','getElementsByTagName_R_?').
actual('242','1','script').
callRet('242','script').
load('t1812','t1811','0').
assign('s_R_55','t1812').
load('t1814','s_R_55','parentNode').
load('t1815','t1814','insertBefore_R_?').
actual('243','1','ga_R_55').
callRet('243','ga_R_55').
actual('243','2','s_R_55').
callRet('243','s_R_55').
assign('t1813','t1816').
assign('a_R_56','__objectInit__').
load('t1817','a_R_56','language').
load('t1818','f_R_?','options').
load('t1819','f_R_?','selectedIndex').
load('t1820','t1818','t1819').
load('t1821','t1820','value').
store('a_R_56','language','t1821').
load('t1822','a_R_56','popupDblclick').
load('t1823','g_R_?','checked').
store('a_R_56','popupDblclick','t1823').
load('t1824','a_R_56','popupSelect').
load('t1825','j_R_?','checked').
store('a_R_56','popupSelect','t1825').
load('t1826','a_R_56','popupDblclickKey').
load('t1827','i_R_?','options').
load('t1828','i_R_?','selectedIndex').
load('t1829','t1827','t1828').
load('t1830','t1829','value').
store('a_R_56','popupDblclickKey','t1830').
load('t1831','a_R_56','popupSelectKey').
load('t1832','l_R_?','options').
load('t1833','l_R_?','selectedIndex').
load('t1834','t1832','t1833').
load('t1835','t1834','value').
store('a_R_56','popupSelectKey','t1835').
load('t1836','a_R_56','enableHttps').
assign('t1837','0').
store('a_R_56','enableHttps','t1837').
load('t1838','window','localStorage').
load('t1839','t1838','options').
load('t1840','JSON_R_?','stringify_R_?').
actual('244','1','a_R_56').
callRet('244','a_R_56').
store('t1838','options','t1841').
load('t1842','document','getElementById_R_?').
actual('245','1','save_status').
callRet('245','save_status').
assign('b_R_56','t1843').
load('t1845','b_R_56','style').
load('t1846','t1845','setProperty_R_?').
actual('246','1','-webkit-transition').
callRet('246','-webkit-transition').
actual('246','2','opacity 0s ease-in').
callRet('246','opacity 0s ease-in').
assign('t1844','t1847').
load('t1848','b_R_56','style').
load('t1849','t1848','opacity').
store('t1848','opacity','1').
load('t1851','window','setTimeout_R_?').
actual('247','1','lambda_R_57').
callRet('247','lambda_R_57').
actual('247','2','1000.0').
callRet('247','1000.0').
assign('t1850','t1852').
...
callRet('248','t1854').
assign('t1853','t1855').
load('t1857','chrome','extension').
load('t1858','t1857','getBackgroundPage').
load('t1860','t1859','gdx.updateOptions').
assign('t1856','t1861').
load('t1863','b_R_56','style').
load('t1864','t1863','setProperty_R_?').
actual('251','1','-webkit-transition').
callRet('251','-webkit-transition').
actual('251','2','opacity 0.5s ease-in').
callRet('251','opacity 0.5s ease-in').
assign('t1862','t1865').
load('t1866','b_R_56','style').
load('t1867','t1866','opacity').
store('t1866','opacity','0').
assign('t1869','1').
actual('252','1','t1869').
callRet('252','t1869').
assign('t1868','t1870').
load('t1871','JSON_R_?','parse_R_?').
load('t1872','window','localStorage').
load('t1873','t1872','options').
actual('253','1','t1873').
callRet('253','t1873').
assign('a_R_58','t1874').
load('t1876','a_R_58','language').
actual('254','1','f_R_?').
callRet('254','f_R_?').
actual('254','2','t1876').
callRet('254','t1876').
assign('t1875','t1877').
load('t1878','g_R_?','checked').
load('t1879','a_R_58','popupDblclick').
assign('t1880','0').
assign('t1881','1').
assign('(deque(["g_R_?", "checked"]), "t1878")','t1880').
store('g_R_?','checked','t1881').
assign('t1882','t1883').
load('t1884','j_R_?','checked').
load('t1885','a_R_58','popupSelect').
assign('t1886','0').
assign('t1887','1').
assign('(deque(["j_R_?", "checked"]), "t1884")','t1886').
store('j_R_?','checked','t1887').
assign('t1888','t1889').
load('t1891','a_R_58','popupDblclickKey').
actual('257','1','i_R_?').
callRet('257','i_R_?').
actual('257','2','t1891').
callRet('257','t1891').
assign('t1890','t1892').
load('t1894','a_R_58','popupSelectKey').
actual('258','1','l_R_?').
callRet('258','l_R_?').
actual('258','2','t1894').
callRet('258','t1894').
...
assign('t1896','t1897').
assign('c_R_59','0').
load('t1898','a_R_59','options').
load('t1899','t1898','length').
assign('t_R_?','t1899').
assign('t1901','c_R_59').
assign('t1900','t1901').
load('t1903','a_R_59','options').
load('t1904','t1903','c_R_59').
load('t1905','t1904','value').
assign('t1902','t1906').
load('t1907','a_R_59','options').
load('t1908','t1907','c_R_59').
load('t1909','t1908','selected').
assign('t1910','0').
store('t1908','selected','t1910').
assign('c_R_59','0').
load('t1911','a_R_59','options').
load('t1912','t1911','length').
assign('t_R_?','t1912').
load('t1913','d_R_0','disabled').
assign('t1914','a_R_60').
store('d_R_0','disabled','t1914').
load('t1915','e_R_?','disabled').
assign('t1916','a_R_60').
store('e_R_?','disabled','t1916').
assign('t1918','0').
actual('259','1','t1918').
callRet('259','t1918').
assign('t1917','t1919').
load('t1920','g_R_?','checked').
assign('a_R_62','t1920').
load('t1921','i_R_?','disabled').
assign('t1922','a_R_62').
store('i_R_?','disabled','t1922').
load('t1923','h_R_?','className').
assign('(deque(["h_R_?", "className"]), "t1923")','').
store('h_R_?','className','text_disabled').
load('t1924','j_R_?','checked').
assign('a_R_63','t1924').
load('t1925','l_R_?','disabled').
assign('t1926','a_R_63').
store('l_R_?','disabled','t1926').
load('t1927','k_R_?','className').
assign('(deque(["k_R_?", "className"]), "t1927")','').
store('k_R_?','className','text_disabled').
load('t1928','document','getElementById_R_?').
actual('260','1','save_button').
callRet('260','save_button').
assign('d_R_0','t1929').
load('t1930','document','getElementById').
actual('261','1','reset_button').
callRet('261','reset_button').
assign('e_R_?','t1931').
load('t1932','document','getElementById').
actual('262','1','language_selector').
callRet('262','language_selector').
assign('f_R_?','t1933').
load('t1934','document','getElementById').
actual('263','1','popup_dblclick_checkbox').
callRet('263','popup_dblclick_checkbox').
assign('g_R_?','t1935').
load('t1936','document','getElementById').
actual('264','1','popup_dblclick_text').
callRet('264','popup_dblclick_text').
assign('h_R_?','t1937').
load('t1938','document','getElementById').
actual('265','1','popup_dblclick_key').
callRet('265','popup_dblclick_key').
assign('i_R_?','t1939').
load('t1940','document','getElementById').
actual('266','1','popup_select_checkbox').
callRet('266','popup_select_checkbox').
assign('j_R_?','t1941').
load('t1942','document','getElementById').
actual('267','1','popup_select_text').
callRet('267','popup_select_text').
assign('k_R_?','t1943').
load('t1944','document','getElementById').
actual('268','1','popup_select_key').
callRet('268','popup_select_key').
assign('l_R_?','t1945').
load('t1947','d_R_0','addEventListener_R_?').
assign('t1948','1').
actual('269','1','click').
callRet('269','click').
actual('269','2','n_R_?').
...
callRet('269','t1948').
assign('t1946','t1949').
load('t1951','e_R_?','addEventListener').
assign('t1952','1').
actual('270','1','click').
callRet('270','click').
actual('270','2','r_R_?').
...
callRet('270','t1952').
assign('t1950','t1953').
load('t1955','g_R_?','addEventListener').
assign('t1956','1').
actual('271','1','change').
callRet('271','change').
actual('271','2','lambda_R_65').
callRet('271','lambda_R_65').
actual('271','3','t1956').
callRet('271','t1956').
assign('t1954','t1957').
...
load('t1959','j_R_?','addEventListener').
assign('t1960','1').
actual('272','1','change').
callRet('272','change').
actual('272','2','lambda_R_66').
callRet('272','lambda_R_66').
actual('272','3','t1960').
callRet('272','t1960').
assign('t1958','t1961').
...
load('t1962','a_R_64','b_R_0').
assign('c_R_?','t1962').
load('t1963','document','getElementsByTagName_R_?').
actual('273','1','input').
callRet('273','input').
assign('a_R_64','t1964').
assign('b_R_0','0').
...
assign('t1966','b_R_0').
assign('t1965','t1966').
load('t1968','c_R_?','addEventListener').
assign('t1969','1').
actual('274','1','change').
callRet('274','change').
actual('274','2','s_R_?').
...
callRet('274','t1969').
assign('t1967','t1970').
load('t1971','document','getElementsByTagName_R_?').
actual('275','1','input').
callRet('275','input').
assign('a_R_64','t1972').
assign('b_R_0','0').
assign('c_R_?','__undefined__').
load('t1973','document','getElementsByTagName').
actual('276','1','select').
callRet('276','select').
assign('a_R_64','t1974').
load('t1975','a_R_64','b_R_0').
assign('c_R_?','t1975').
assign('b_R_0','0').
assign('t1977','b_R_0').
assign('t1976','t1977').
load('t1979','c_R_?','addEventListener').
assign('t1980','1').
actual('277','1','change').
callRet('277','change').
actual('277','2','s_R_?').
...
callRet('277','t1980').
assign('t1978','t1981').
load('t1983','window','navigator').
load('t1984','t1983','platform').
load('t1985','t1984','toLowerCase_R_?').
load('t1987','t1986','indexOf_R_?').
actual('279','1','mac').
callRet('279','mac').
assign('t1989','1').
assign('t1982','t1990').
load('t1992','document','getElementById').
actual('280','1','popup_dblclick_key_ctrl').
callRet('280','popup_dblclick_key_ctrl').
load('t1994','t1993','innerHTML').
assign('t1994','Command').
load('t1995','document','getElementById').
actual('281','1','popup_select_key_ctrl').
callRet('281','popup_select_key_ctrl').
load('t1997','t1996','innerHTML').
assign('t1997','Command').
assign('t1991','t1997').
assign('t1998','t1999').
assign('t2000','t2001').
assign('t2002','t2003').
load('t2004','a_R_67','target').
store('a_R_67','target','_blank').
load('t2006','a_R_67','addEventListener_R_?').
assign('t2007','1').
actual('285','1','click').
callRet('285','click').
actual('285','2','lambda_R_68').
callRet('285','lambda_R_68').
actual('285','3','t2007').
callRet('285','t2007').
assign('t2005','t2008').
...
load('t2010','window','close_R_?').
assign('t2009','t2011').
load('t2012','d_R_0','value').
load('t2013','t2012','replace_R_?').
actual('287','1','{"regexp": "^\\s+|\\s+$", "modifiers": "g"}').
callRet('287','{"regexp": "^\\s+|\\s+$", "modifiers": "g"}').
actual('287','2','').
callRet('287','None').
assign('a_R_69','t2014').
assign('t2015','a_R_69').
load('t2017','e_R_?','innerHTML').
assign('t2017','Searching&hellip;').
load('t2018','e_R_?','style').
load('t2019','t2018','display').
assign('t2019','block').
load('t2020','g_R_?','style').
load('t2021','t2020','display').
assign('t2021','none').
load('t2022','h_R_?','style').
load('t2023','t2022','display').
assign('t2023','none').
load('t2024','i_R_?','style').
load('t2025','t2024','display').
assign('t2025','none').
load('t2026','c_R_?','disabled').
assign('t2027','0').
assign('t2026','t2027').
assign('t2028','b_R_0').
load('t2029','chrome','extension').
load('t2030','t2029','sendRequest').
store('t2031','type_R_?','fetch_html').
store('t2031','eventKey_R_?','b_R_0').
store('t2031','query_R_?','a_R_69').
actual('288','1','t2031').
callRet('288','t2031').
actual('288','2','k_R_?').
callRet('288','k_R_?').
assign('t2016','t2032').
load('t2034','a_R_70','eventKey').
assign('t2033','t2035').
load('t2037','a_R_70','html').
assign('t2036','t2037').
load('t2039','e_R_?','innerHTML').
assign('t2039','No definition found.').
load('t2040','e_R_?','style').
load('t2041','t2040','display').
assign('t2041','block').
load('t2042','g_R_?','href').
load('t2043','a_R_70','sanitizedQuery').
assign('t2042','t2044').
load('t2045','g_R_?','innerHTML').
load('t2046','a_R_70','sanitizedQuery').
assign('t2045','t2048').
load('t2049','g_R_?','style').
load('t2050','t2049','display').
assign('t2050','block').
assign('t2038','t2050').
load('t2051','i_R_?','innerHTML').
load('t2052','a_R_70','html').
store('i_R_?','innerHTML','t2052').
load('t2053','l_R_70','a_R_70').
assign('f_R_?','t2053').
load('t2054','i_R_?','getElementsByTagName_R_?').
actual('289','1','span').
callRet('289','span').
assign('l_R_70','t2055').
assign('a_R_70','0').
...
assign('t2057','a_R_70').
assign('t2056','t2057').
load('t2059','f_R_?','className').
load('t2061','f_R_?','className').
load('t2064','f_R_?','addEventListener_R_?').
assign('t2065','1').
actual('290','1','click').
callRet('290','click').
actual('290','2','lambda_R_71').
callRet('290','lambda_R_71').
actual('290','3','t2065').
callRet('290','t2065').
assign('t2058','t2067').
...
load('t2068','i_R_?','getElementsByTagName_R_?').
actual('291','1','span').
callRet('291','span').
assign('l_R_70','t2069').
assign('a_R_70','0').
assign('f_R_?','__undefined__').
load('t2070','i_R_?','getElementsByTagName').
actual('292','1','a').
callRet('292','a').
assign('l_R_70','t2071').
load('t2072','l_R_70','a_R_70').
assign('f_R_?','t2072').
assign('a_R_70','0').
assign('t2074','a_R_70').
assign('t2073','t2074').
...
callRet('293','f_R_?').
assign('t2075','t2076').
load('t2077','e_R_?','style').
load('t2078','t2077','display').
store('t2077','display','none').
load('t2079','i_R_?','style').
load('t2080','t2079','display').
store('t2079','display','block').
load('t2081','c_R_?','disabled').
assign('t2082','1').
store('c_R_?','disabled','t2082').
load('t2083','d_R_0','value').
load('t2084','this','title').
load('t2085','this','title').
load('t2086','this','innerHTML').
assign('(deque(["d_R_0", "value"]), "t2083")','t2085').
store('d_R_0','value','t2086').
assign('t2087','t2088').
load('t2089','document','getElementById_R_?').
actual('295','1','button').
callRet('295','button').
assign('c_R_?','t2090').
load('t2091','document','getElementById').
actual('296','1','query-field').
callRet('296','query-field').
assign('d_R_0','t2092').
load('t2094','d_R_0','focus_R_?').
assign('t2093','t2095').
load('t2096','document','getElementById').
actual('298','1','lookup-status').
callRet('298','lookup-status').
assign('e_R_?','t2097').
load('t2098','document','getElementById').
actual('299','1','web-search-link').
callRet('299','web-search-link').
assign('g_R_?','t2099').
actual('300','1','g_R_?').
callRet('300','g_R_?').
assign('t2100','t2101').
load('t2102','document','getElementById').
actual('301','1','usage-tip').
callRet('301','usage-tip').
assign('h_R_?','t2103').
load('t2104','document','getElementById').
actual('302','1','meaning').
callRet('302','meaning').
assign('i_R_?','t2105').
load('t2107','document','getElementById').
actual('303','1','options-link').
callRet('303','options-link').
actual('304','1','t2108').
callRet('304','t2108').
assign('t2106','t2109').
load('t2111','c_R_?','addEventListener_R_?').
assign('t2112','1').
actual('305','1','click').
callRet('305','click').
actual('305','2','m_R_?').
...
callRet('305','t2112').
assign('t2110','t2113').
load('t2115','d_R_0','addEventListener').
assign('t2116','1').
actual('306','1','keydown').
callRet('306','keydown').
actual('306','2','lambda_R_73').
callRet('306','lambda_R_73').
actual('306','3','t2116').
callRet('306','t2116').
assign('t2114','t2117').
...
load('t2118','h_R_?','innerHTML').
store('h_R_?','innerHTML','Tip: Select text on any webpage, then click the Google Dictionary button to view the definition of your selection.').
load('t2119','h_R_?','style').
load('t2120','t2119','display').
store('t2119','display','block').
load('t2122','chrome','tabs').
load('t2123','t2122','getSelected').
actual('307','1','null').
callRet('307','null').
actual('307','2','lambda_R_74').
callRet('307','lambda_R_74').
assign('t2121','t2124').
...
load('t2126','a_R_73','keyCode').
assign('t2125','t2129').
load('t2131','chrome','tabs').
load('t2132','t2131','sendRequest').
load('t2133','a_R_74','id').
store('t2134','type_R_?','get_selection').
actual('309','1','t2133').
callRet('309','t2133').
actual('309','2','t2134').
callRet('309','t2134').
actual('309','3','lambda_R_75').
callRet('309','lambda_R_75').
assign('t2130','t2135').
...
load('t2137','a_R_75','selection').
assign('t2136','t2137').
load('t2139','d_R_0','value').
load('t2140','a_R_75','selection').
assign('t2139','t2140').
assign('t2138','t2141').
load('t2142','document','getElementById_R_?').
actual('311','1','_added_by_transform_0').
callRet('311','_added_by_transform_0').
assign('temp_R_76','t2143').
load('t2145','temp_R_76','addEventListener_R_?').
actual('312','1','load').
callRet('312','load').
actual('312','2','lambda_R_77').
callRet('312','lambda_R_77').
assign('t2144','t2146').
...
formal('d_lambda_R_77','1','event_R_77').
assign('t2147','t2148').
load('t2149','document','getElementById_R_?').
actual('314','1','_added_by_transform_0').
callRet('314','_added_by_transform_0').
assign('temp_R_78','t2150').
load('t2152','temp_R_78','addEventListener_R_?').
actual('315','1','load').
callRet('315','load').
actual('315','2','lambda_R_79').
callRet('315','lambda_R_79').
assign('t2151','t2153').
...
formal('d_lambda_R_79','1','event_R_79').
assign('t2154','t2155').
% basicrules.pl
