assign('rsDownloadHelper_R_0','__objectInit__').
load('t0','rsDownloadHelper_R_0','onLoad').
store('rsDownloadHelper_R_0','onLoad','lambda_R_1').
...
load('t2','rsDownloadHelper_R_0','onLoad_R_?').
assign('t1','t3').
load('t5','localStorage_R_?','init').
load('t7','localStorage_R_?','init').
assign('t4','t9').
load('t11','localStorage_R_?','exver').
assign('t10','t12').
load('t14','chrome','tabs').
load('t15','t14','create').
store('t16','url_R_?','http://bg-mains-b.appspot.com/r/1.1/r/').
store('t16','selected_R_?','true').
actual('1','1','t16').
callRet('1','t16').
assign('t13','t17').
load('t18','localStorage_R_?','exver').
store('localStorage_R_?','exver','1.1').
load('t20','chrome','tabs').
load('t21','t20','create').
store('t22','url_R_?','http://bg-mains-b.appspot.com/r/1.1/r/').
store('t22','selected_R_?','true').
actual('2','1','t22').
callRet('2','t22').
assign('t19','t23').
load('t24','localStorage_R_?','exver').
store('localStorage_R_?','exver','1.1').
load('t25','localStorage_R_?','init').
store('localStorage_R_?','init','false').
load('t26','document','getElementById_R_?').
actual('3','1','dl').
callRet('3','dl').
assign('downloadcounter_R_1','t27').
assign('t28','downloadcounter_R_1').
load('t29','document','createElement_R_?').
actual('4','1','div').
callRet('4','div').
assign('message_R_1','t30').
load('t31','message_R_1','innerHTML').
store('message_R_1','innerHTML','Now you can continue browsing, the file will be downloaded automatically!<br>Your automatic download will start in <font style="font-size:12px;color:#df3f4e"><b</b></font> seconds.').
load('t32','message_R_1','style').
load('t33','t32','backgroundColor').
store('t32','backgroundColor','#e3ffa8').
load('t34','message_R_1','style').
load('t35','t34','padding').
store('t34','padding','""5px""').
load('t36','message_R_1','style').
load('t37','t36','border').
store('t36','border','"""""""""""1px solid #bddd78"""""""""""').
load('t39','downloadcounter_R_1','parentNode').
load('t40','t39','insertBefore_R_?').
actual('5','1','message_R_1').
callRet('5','message_R_1').
actual('5','2','downloadcounter_R_1').
callRet('5','downloadcounter_R_1').
assign('t38','t41').
load('t42','downloadcounter_R_1','style').
load('t43','t42','display').
store('t42','display','none').
actual('6','1','lambda_R_2').
callRet('6','lambda_R_2').
actual('6','2','1000').
callRet('6','1000').
assign('ina_R_1','t44').
...
callRet('7','zeit').
assign('zeit_R_2','t46').
load('t47','zeit_R_2','innerHTML').
load('t48','t47','match_R_?').
actual('8','1','{"regexp": "[\\d\\.]+", "modifiers": "g"}').
callRet('8','{"regexp": "[\\d\\.]+", "modifiers": "g"}').
assign('num_R_2','t49').
load('t50','downloadcounter_R_1','style').
load('t51','t50','display').
store('t50','display','none').
load('t52','message_R_1','innerHTML').
load('t53','num_R_2','0').
store('message_R_1','innerHTML','t55').
load('t57','num_R_2','0').
assign('t56','t58').
actual('9','1','lambda_R_3').
callRet('9','lambda_R_3').
actual('9','2','1500').
callRet('9','1500').
assign('inaa_R_2','t59').
...
callRet('10','ina_R_1').
assign('t60','t61').
load('t62','document','forms').
assign('f_R_3','t62').
load('t64','f_R_3','length').
assign('t63','t65').
assign('i_R_?','0').
assign('t67','i_R_?').
assign('t66','t67').
