assign('interval_R_0','__undefined__').
assign('globalEvent_R_0','null').
assign('mouseUpInterval_R_0','__undefined__').
assign('menuDiv_R_0','__undefined__').
ptsTo('hideDirectionsButton_R_1','d_hideDirectionsButton_R_1').
heapPtsTo('d_hideDirectionsButton_R_1','prototype','p_hideDirectionsButton_R_1').
prototype('p_hideDirectionsButton_R_1','h_FP').
methodRet('d_hideDirectionsButton_R_1','hideDirectionsButton_R_1').
ptsTo('executeIfAddress_R_2','d_executeIfAddress_R_2').
heapPtsTo('d_executeIfAddress_R_2','prototype','p_executeIfAddress_R_2').
prototype('p_executeIfAddress_R_2','h_FP').
methodRet('d_executeIfAddress_R_2','executeIfAddress_R_2').
formal('d_executeIfAddress_R_2','1','text_R_2').
formal('d_executeIfAddress_R_2','2','callback_R_2').
ptsTo('getMenuItemHtml_R_4','d_getMenuItemHtml_R_4').
heapPtsTo('d_getMenuItemHtml_R_4','prototype','p_getMenuItemHtml_R_4').
prototype('p_getMenuItemHtml_R_4','h_FP').
methodRet('d_getMenuItemHtml_R_4','getMenuItemHtml_R_4').
formal('d_getMenuItemHtml_R_4','1','icon_R_4').
formal('d_getMenuItemHtml_R_4','2','text_R_4').
formal('d_getMenuItemHtml_R_4','3','link_R_4').
ptsTo('isPotentialAddress_R_5','d_isPotentialAddress_R_5').
heapPtsTo('d_isPotentialAddress_R_5','prototype','p_isPotentialAddress_R_5').
prototype('p_isPotentialAddress_R_5','h_FP').
methodRet('d_isPotentialAddress_R_5','isPotentialAddress_R_5').
formal('d_isPotentialAddress_R_5','1','text_R_5').
ptsTo('maybeDisplayDirections_R_6','d_maybeDisplayDirections_R_6').
heapPtsTo('d_maybeDisplayDirections_R_6','prototype','p_maybeDisplayDirections_R_6').
prototype('p_maybeDisplayDirections_R_6','h_FP').
methodRet('d_maybeDisplayDirections_R_6','maybeDisplayDirections_R_6').
formal('d_maybeDisplayDirections_R_6','1','x_R_6').
formal('d_maybeDisplayDirections_R_6','2','y_R_6').
formal('d_maybeDisplayDirections_R_6','3','text_R_6').
ptsTo('maybeReactToMouseUpEvent_R_8','d_maybeReactToMouseUpEvent_R_8').
heapPtsTo('d_maybeReactToMouseUpEvent_R_8','prototype','p_maybeReactToMouseUpEvent_R_8').
prototype('p_maybeReactToMouseUpEvent_R_8','h_FP').
methodRet('d_maybeReactToMouseUpEvent_R_8','maybeReactToMouseUpEvent_R_8').
ptsTo('attachSelectListener_R_9','d_attachSelectListener_R_9').
heapPtsTo('d_attachSelectListener_R_9','prototype','p_attachSelectListener_R_9').
prototype('p_attachSelectListener_R_9','h_FP').
methodRet('d_attachSelectListener_R_9','attachSelectListener_R_9').
formal('d_attachSelectListener_R_9','1','body_R_9').
ptsTo('main_R_11','d_main_R_11').
heapPtsTo('d_main_R_11','prototype','p_main_R_11').
prototype('p_main_R_11','h_FP').
methodRet('d_main_R_11','main_R_11').
assign('t0','t1').
assign('geocoder_R_0','__undefined__').
ptsTo('initialize_R_12','d_initialize_R_12').
heapPtsTo('d_initialize_R_12','prototype','p_initialize_R_12').
prototype('p_initialize_R_12','h_FP').
methodRet('d_initialize_R_12','initialize_R_12').
ptsTo('codeAddress_R_13','d_codeAddress_R_13').
heapPtsTo('d_codeAddress_R_13','prototype','p_codeAddress_R_13').
prototype('p_codeAddress_R_13','h_FP').
methodRet('d_codeAddress_R_13','codeAddress_R_13').
formal('d_codeAddress_R_13','1','address_R_13').
formal('d_codeAddress_R_13','2','callback_R_13').
load('t3','chrome','extension').
load('t4','t3','onRequest').
load('t5','t4','addListener').
actual('1','1','lambda_R_15').
callRet('1','lambda_R_15').
assign('t2','t6').
...
formal('d_lambda_R_15','1','request_R_15').
formal('d_lambda_R_15','2','sender_R_15').
formal('d_lambda_R_15','3','sendResponse_R_15').
assign('t7','t8').
...
load('t10','window','clearInterval_R_?').
actual('3','1','interval_R_0').
callRet('3','interval_R_0').
assign('t9','t11').
load('t12','menuDiv_R_0','style').
load('t13','t12','display').
store('t12','display','none').
load('t15','chrome','extension').
load('t16','t15','sendRequest').
store('t17','greeting_R_?','t18').
actual('4','1','t17').
callRet('4','t17').
actual('4','2','lambda_R_3').
callRet('4','lambda_R_3').
assign('t14','t19').
...
assign('t20','t21').
actual('5','1','response_R_3').
callRet('5','response_R_3').
assign('t22','t23').
load('t25','console','log_R_?').
actual('6','1','t29').
callRet('6','t29').
assign('t24','t30').
...
actual('7','1','icon_R_4').
callRet('7','icon_R_4').
methodRet('d_getMenuItemHtml_R_4','t43').
load('t44','text_R_5','replace_R_?').
actual('8','1',',').
callRet('8',',').
actual('8','2','').
callRet('8','None').
assign('text_R_5','t45').
load('t46','text_R_5','replace').
actual('9','1','{"regexp": "[ ]+", "modifiers": ""}').
callRet('9','{"regexp": "[ ]+", "modifiers": ""}').
actual('9','2',' ').
callRet('9',' ').
assign('text_R_5','t47').
load('t49','text_R_5','match_R_?').
actual('10','1','{"regexp": "[0-9]+", "modifiers": ""}').
callRet('10','{"regexp": "[0-9]+", "modifiers": ""}').
assign('t51','t50').
assign('t48','t51').
methodRet('d_isPotentialAddress_R_5','false').
load('t53','text_R_5','match').
actual('11','1','{"regexp": "[a-zA-Z]+", "modifiers": ""}').
callRet('11','{"regexp": "[a-zA-Z]+", "modifiers": ""}').
assign('t55','t54').
assign('t52','t55').
methodRet('d_isPotentialAddress_R_5','false').
load('t56','text_R_5','split_R_?').
actual('12','1',' ').
callRet('12',' ').
load('t58','t57','length').
assign('wordCount_R_5','t58').
assign('t59','t62').
methodRet('d_isPotentialAddress_R_5','false').
methodRet('d_isPotentialAddress_R_5','true').
load('t64','window','clearInterval_R_?').
actual('13','1','interval_R_0').
callRet('13','interval_R_0').
assign('t63','t65').
actual('14','1','text_R_6').
callRet('14','text_R_6').
assign('t68','t67').
assign('t66','t68').
methodRet('d_maybeDisplayDirections_R_6','null').
actual('15','1','text_R_6').
callRet('15','text_R_6').
actual('15','2','lambda_R_7').
callRet('15','lambda_R_7').
assign('t69','t70').
...
formal('d_lambda_R_7','1','addr_R_7').
load('t71','menuDiv_R_0','style').
load('t72','t71','left').
store('t71','left','t73').
load('t74','menuDiv_R_0','style').
load('t75','t74','top').
store('t74','top','t76').
load('t77','menuDiv_R_0','innerHTML').
actual('16','1','marker.png').
callRet('16','marker.png').
actual('16','2','Show on map').
callRet('16','Show on map').
actual('16','3','t79').
callRet('16','t79').
actual('17','1','maps_up25x25.png').
callRet('17','maps_up25x25.png').
actual('17','2','Get directions to here').
callRet('17','Get directions to here').
actual('17','3','t85').
callRet('17','t85').
store('menuDiv_R_0','innerHTML','t87').
load('t88','menuDiv_R_0','style').
load('t89','t88','display').
store('t88','display','block').
load('t90','window','setInterval_R_?').
actual('18','1','hideDirectionsButton_R_?').
callRet('18','hideDirectionsButton_R_?').
actual('18','2','3000').
callRet('18','3000').
assign('interval_R_0','t91').
load('t93','window','clearInterval_R_?').
actual('19','1','mouseUpInterval_R_0').
callRet('19','mouseUpInterval_R_0').
assign('t92','t94').
assign('t95','t96').
methodRet('d_maybeReactToMouseUpEvent_R_8','null').
load('t97','window','getSelection_R_?').
assign('selection_R_8','t98').
load('t100','selection_R_8','toString').
assign('t99','t102').
assign('t103','t104').
load('t106','globalEvent_R_0','pageX').
load('t107','globalEvent_R_0','pageY').
load('t108','selection_R_8','toString_R_?').
actual('24','1','t106').
callRet('24','t106').
actual('24','2','t107').
callRet('24','t107').
...
assign('t105','t110').
assign('globalEvent_R_0','null').
load('t112','body_R_9','addEventListener_R_?').
actual('25','1','mouseup').
callRet('25','mouseup').
actual('25','2','lambda_R_10').
callRet('25','lambda_R_10').
assign('t111','t113').
...
formal('d_lambda_R_10','1','event_R_10').
assign('globalEvent_R_0','event_R_10').
load('t114','window','setInterval_R_?').
actual('26','1','maybeReactToMouseUpEvent_R_?').
callRet('26','maybeReactToMouseUpEvent_R_?').
actual('26','2','200').
callRet('26','200').
assign('mouseUpInterval_R_0','t115').
load('t116','document','createElement_R_?').
actual('27','1','div').
callRet('27','div').
assign('menuDiv_R_0','t117').
load('t119','menuDiv_R_0','setAttribute_R_?').
actual('28','1','id').
callRet('28','id').
actual('28','2','directions_extension').
callRet('28','directions_extension').
assign('t118','t120').
load('t121','menuDiv_R_0','style').
load('t122','t121','position').
store('t121','position','absolute !important').
load('t123','menuDiv_R_0','style').
load('t124','t123','background').
store('t123','background','#EEEEFF !important').
load('t125','menuDiv_R_0','style').
load('t126','t125','border').
store('t125','border','""""""""""""""""""""""1px solid #AAAAFF !important""""""""""""""""""""""').
load('t127','menuDiv_R_0','style').
load('t128','t127','padding').
store('t127','padding','"""""""""""3px !important"""""""""""').
load('t129','menuDiv_R_0','style').
load('t130','t129','display').
store('t129','display','none').
load('t131','menuDiv_R_0','style').
load('t132','t131','-webkit-border-radius').
store('t131','-webkit-border-radius','"""""""""""5px !important"""""""""""').
load('t134','document','body').
load('t135','t134','appendChild_R_?').
actual('29','1','menuDiv_R_0').
callRet('29','menuDiv_R_0').
assign('t133','t136').
load('t138','document','body').
actual('30','1','t138').
callRet('30','t138').
assign('t137','t139').
load('t140','google_R_?','maps').
load('t141','t140','Geocoder').
ptsTo('t142','n_t141_0').
prototype('n_t141_0', 'p_t141').
assign('geocoder_R_0','t142').
assign('t143','geocoder_R_0').
load('t145','geocoder_R_0','geocode_R_?').
store('t146','address','address_R_13').
actual('31','1','t146').
callRet('31','t146').
actual('31','2','lambda_R_14').
callRet('31','lambda_R_14').
assign('t144','t147').
...
formal('d_lambda_R_14','1','results_R_14').
formal('d_lambda_R_14','2','status_R_14').
assign('text_R_?','').
load('t149','google_R_?','maps').
load('t150','t149','GeocoderStatus').
load('t151','t150','OK').
assign('t148','t152').
load('t153','results_R_14','0').
load('t154','t153','formatted_address').
assign('text_R_?','t154').
actual('32','1','text_R_?').
callRet('32','text_R_?').
assign('t155','t156').
load('t158','request_R_15','greeting').
actual('33','1','t158').
callRet('33','t158').
actual('33','2','lambda_R_16').
callRet('33','lambda_R_16').
assign('t157','t159').
...
formal('d_lambda_R_16','1','resp_R_16').
actual('34','1','resp_R_16').
callRet('34','resp_R_16').
assign('t160','t161').
load('t162','document','getElementById_R_?').
actual('35','1','_added_by_transform_0').
callRet('35','_added_by_transform_0').
assign('temp_R_17','t163').
load('t165','temp_R_17','addEventListener_R_?').
actual('36','1','load').
callRet('36','load').
actual('36','2','lambda_R_18').
callRet('36','lambda_R_18').
assign('t164','t166').
